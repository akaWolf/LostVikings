#pragma once
// Embedded 8x8 ASCII bitmap font.
//
// Covers printable ASCII (0x20..0x7E = 95 glyphs). Each glyph is 8 bytes,
// one per row; MSB is leftmost pixel. Style: compact CGA-derived pattern
// hand-written for legibility at small sizes.
//
// Public-domain — no attribution required.

#include <cstdint>

inline const uint8_t kFont8x8[95][8] = {
    ...
    /* 0x51 'Q' */ {0x7C,0xC6,0xC6,0xC6,0xCE,0x7C,0x0E,0x00},
    ...
    /* 0x66 'f' */ {0x3C,0x66,0x60,0xF8,0x60,0x60,0xF0,0x00},
    ...
    /* 0x79 'y' */ {0x00,0x00,0x66,0x66,0x66,0x3E,0x06,0xFC},

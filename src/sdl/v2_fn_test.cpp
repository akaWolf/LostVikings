...
extern std::atomic<uint8_t> sdl_spec_state[256]; // unit sub_105cb Y/N presets
extern uint8_t* v2_vm_get_shadow_chunk();   // 0x2ABA0-byte chunk-buffer shadow
extern uint8_t* v2_vm_get_shadow_tilemap();     // unit sub_11204 dest compares
extern uint8_t* v2_vm_get_shadow_tilegfx();
extern uint8_t* v2_vm_get_shadow_gs();
extern uint8_t* v2_vm_get_shadow_gs_tiledata();
extern uint8_t* v2_vm_get_shadow_animdata();  // unit sub_111b1 template compare
...
enum FtId { FT_SUB_15972 = 0, FT_SUB_161A1 = 1, FT_SUB_15DA8 = 2, FT_SUB_15D6B = 3,
            ...
            FT_SUB_1462E = 190,
            // Table wave 4: accumulator get/set family + flip redirects.
            FT_SUB_14646 = 191, FT_SUB_14652 = 192, FT_SUB_1466E = 193,
            FT_SUB_14675 = 194, FT_SUB_14681 = 195, FT_SUB_14686 = 196,
            ...
            // Table wave 6: OR/XOR field ops + channel-compare jumps.
            FT_SUB_147E7 = 216, FT_SUB_147FF = 217, FT_SUB_1480B = 218,
            FT_SUB_14827 = 219, FT_SUB_1483F = 220, FT_SUB_1484B = 221,
            ...
            // Table wave 8: equality channel-compare jump/call forms (72-8F).
            FT_SUB_149F3 = 241,
            FT_SUB_14A0B = 242,
            FT_SUB_14A1B = 243,
            FT_SUB_14A2B = 244,
            ...
            FT_SUB_14B2B = 260,
            FT_SUB_14B3B = 261,
            // Table wave 9: bittest->acc cores, conditional kill-bit forms
            // and bittest/RNG compare jumps (97-BB).
            FT_SUB_14B4B = 262,
            FT_SUB_14B52 = 263,
            FT_SUB_14B59 = 264,
            FT_SUB_14B60 = 265,
            ...
            // wave B1b: tile helpers + channel getters
            FT_SUB_14199 = 356,   // tile type at pixel coords
            FT_SUB_141A7 = 357,   // tile type at tile coords
            FT_SUB_141B3 = 358,   // tile index low10
            FT_SUB_141BA = 359,   // tile word read + bounds
            FT_SUB_141E0 = 360,   // tile word write
            FT_SUB_1547E = 361,   // ch0 literal
            ...
            FT_SUB_1227E = 375,   // delta scale 2/3
            FT_SUB_122C0 = 376,   // delta scale 1/3 rounded
            FT_SUB_122F3 = 377,   // delta scale 1/3 trunc
            ...
            FT_SUB_12709 = 415,   // dialog-box cmd from buffer
            FT_SUB_10E85 = 416,   // para advance (register-pure)
            FT_SUB_11204 = 417,   // level chunk-load dispatcher
            FT_SUB_12D72 = 418,   // demo input record/replay tick
            FT_SUB_1041C = 419,   // pw-screen gate prefix
            ...
            FT_SUB_179A8 = 436,   // joystick timer calibration
            FT_SUB_108C8 = 437,   // F10+S mute toggle (SFX stop sweep)
            FT_SUB_17337 = 438,   // MDA debug print
            FT_SUB_172D3 = 439,   // MDA debug print (far)
            FT_SUB_11BA5 = 440,   // TAB pause/inventory loop
...
const char* g_name[FT_COUNT] = { "sub_15972", "sub_161a1", "sub_15da8", "sub_15d6b",
                                 ...
                                 "sub_149f3", "sub_14a0b", "sub_14a1b",
                                 "sub_14a2b", "sub_14a3b", "sub_14a4b",
                                 "sub_14a5b", "sub_14a6b", "sub_14a7b",
                                 "sub_14a8b", "sub_14a9b", "sub_14aab",
                                 "sub_14abb", "sub_14acb", "sub_14adb",
                                 "sub_14aeb", "sub_14afb", "sub_14b0b",
                                 "sub_14b1b", "sub_14b2b", "sub_14b3b",
                                 "sub_14b4b", "sub_14b52", "sub_14b59",
                                 "sub_14b60", "sub_14b67", "sub_14b71",
                                 "sub_14ba7", "sub_14bcf", "sub_14c09",
                                 "sub_14c37", "sub_14c59", "sub_14c8d",
                                 "sub_14cbb", "sub_14cdd", "sub_14d0f",
                                 "sub_14d3d", "sub_14d5f", "sub_14d91",
                                 "sub_14da1", "sub_14db1", "sub_14dc1",
                                 "sub_14dd1", "sub_14de4", "sub_14df4",
                                 "sub_14e04", "sub_14e14", "sub_14e24",
...
// Guided-fuzz hook: FT_FUZZ_SEED=<hex|dec> overrides every runner's baked
// seed (tests/fn_fuzz_guided.sh keeps seeds that light up new gcov lines).
static uint32_t ft_seed(uint32_t def) {
    static long has = -1; static uint32_t v = 0;
    if (has < 0) {
        const char* e = getenv("FT_FUZZ_SEED");
        has = (e && e[0]) ? 1 : 0;
        if (has) v = (uint32_t)strtoul(e, nullptr, 0);
    }
    return has ? v : def;
}
...
// ---------------------------------------------------------------------------
// Wave B1b: tile helpers (14199/141a7/141b3/141ba/141e0) and channel getters
// (1547e/15485/1549a/154a3) as direct units.
// Tiles: [2E63] points at the game DS segment (v2_fntest_ds_seg_override) so
// the map lives INSIDE the compared DS image for both sides; a synthetic map
// (row LUT at [di*2-0x7098], rows at 0xC200+) is planted in g_synth_in.
// Getters: the byte stream sits in the FT_VM_TESTSEG zone (oracle via
// v2_fntest_es_override, v2 via vm.es at the same m2c bytes); compared: DS
// image, returned AX, and stream consumption (oracle BX vs v2 pc).
extern "C" void v2_fntest_call_tile(int which, uint8_t* shadow, uint16_t si,
                                    uint16_t di, uint16_t ax_in, uint16_t* out_ax);
...
int ft_selftest_b1b(FtId id, uint32_t seed) {
    ...
    v2_set_m2c_base(v2_fntest_m2c_base());
    uint16_t dsseg = (uint16_t)(v2_fntest_game_ds_linear() >> 4);
    const uint16_t W = 8, H = 6, ROWS = 0xC200;
    bool is_tile = (id == FT_SUB_14199 || id == FT_SUB_141A7 || id == FT_SUB_141B3 ||
                    id == FT_SUB_141BA || id == FT_SUB_141E0);
    int which = (id == FT_SUB_141BA) ? 0 : (id == FT_SUB_141B3) ? 1 :
                (id == FT_SUB_141A7) ? 2 : (id == FT_SUB_14199) ? 3 :
                (id == FT_SUB_141E0) ? 4 :
                (id == FT_SUB_1547E) ? 0 : (id == FT_SUB_15485) ? 1 :
                (id == FT_SUB_1549A) ? 2 : 3;
    FtRng rng(seed);

    // one case: build DS (+zone for getters), run oracle, run v2, compare
    auto CASE = [&](uint16_t si, uint16_t di, uint16_t ax_in,
                    const uint8_t* stream, int slen, uint16_t obj42,
                    const char* tag, FtSynthStats& st) {
        st.cases++;
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        ft_wr16(g_synth_in, 0x42, obj42);
        if (is_tile) {
            ft_wr16(g_synth_in, 0x25DC, W);
            ft_wr16(g_synth_in, 0x25DE, H);
            ft_wr16(g_synth_in, 0x2E63, dsseg);
            for (uint16_t r = 0; r < H + 2; r++)   // row LUT (+2 rows of slack)
                ft_wr16(g_synth_in, (uint16_t)((uint16_t)(r * 2) - 0x7098),
                        (uint16_t)(ROWS + r * W * 2));
            FtRng mr(seed ^ 0x7117E5u);            // deterministic map fill
            for (uint16_t a = 0; a < (uint16_t)((H + 2) * W * 2); a += 2)
                ft_wr16(g_synth_in, (uint16_t)(ROWS + a), mr.w());
        }
        ...
        if (!is_tile) {
            ...
            for (int i = slen; i < 64; i++) zone[0x100 + i] = 0xEE;  // canary pad
        }

        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { ax_in, 0x100, 0, 0, si, di, 0, 0 };
        long esc0 = ft_ub_marks();
        if (!is_tile) v2_fntest_es_override = FT_VM_TESTSEG;
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
        if (!is_tile) v2_fntest_es_override = 0;
        if (ft_ub_marks() != esc0) {
            st.cases--;
            if (!is_tile) memcpy(zone + 0x100, zone_save, 64);
            return;
        }

        memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
        uint16_t v2_ax = 0, v2_pc = 0;
        if (is_tile) {
            v2_fntest_ds_seg_override = dsseg;
            v2_fntest_ds_seg_ptr = g_scratch;
            v2_fntest_call_tile(which, g_scratch, si, di, ax_in, &v2_ax);
            v2_fntest_ds_seg_override = 0;
            v2_fntest_ds_seg_ptr = nullptr;
        } else {
            v2_fntest_call_ch_getter(which, g_scratch, 0x100, FT_VM_TESTSEG,
                                     &v2_ax, &v2_pc);
        }

        long diffs = 0;
        if (id != FT_SUB_141E0 && regs[0] != v2_ax) {   // returned AX (write unit: no ret)
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[%s %s]: AX orig=%04X v2=%04X | si=%04X di=%04X ax=%04X\n",
                        g_name[id], tag, regs[0], v2_ax, si, di, ax_in);
            diffs++;
        }
        if (!is_tile && regs[1] != v2_pc) {             // consumption: oracle BX vs v2 pc
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[%s %s]: BX orig=%04X v2-pc=%04X | s0=%02X\n",
                        g_name[id], tag, regs[1], v2_pc, stream ? stream[0] : 0);
            diffs++;
        }
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_scratch[a] == g_synth_orig[a]) continue;
            if (v2_fntest_ds_skip(a)) continue;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[%s %s]: addr=%04X orig=%02X v2=%02X (in=%02X) | si=%04X di=%04X\n",
                        g_name[id], tag, a, g_synth_orig[a], g_scratch[a], g_synth_in[a], si, di);
            diffs++;
        }
        if (!is_tile) memcpy(zone + 0x100, zone_save, 64);
    ...
    if (is_tile) {
        // Bounds lattice: si in {0..W+1, 0x7FFF, 0xFFFF} × di in {0..H+1, 0x8000}
        static const uint16_t SIV[] = {0, 1, W - 1, W, W + 1, 0x7FFF, 0xFFFF};
        static const uint16_t DIV[] = {0, 1, H - 1, H, H + 1, 0x8000};
        for (uint16_t s : SIV) for (uint16_t d : DIV) {
            uint16_t sv = s, dv = d;
            if (id == FT_SUB_14199) { sv = (uint16_t)(sv << 4 | (rng.next() & 15));
                                      dv = (uint16_t)(dv << 4 | (rng.next() & 15)); }
            CASE(sv, dv, (uint16_t)rng.w(), nullptr, 0, 6, "grid", grid);
        }
        for (int i = 0; i < 300; i++) {
            uint16_t s = (uint16_t)(rng.next() % (W + 3));
            uint16_t d = (uint16_t)(rng.next() % (H + 3));
            if (id == FT_SUB_14199) { s = (uint16_t)(s * 16 + (rng.next() & 15));
                                      d = (uint16_t)(d * 16 + (rng.next() & 15)); }
            CASE(s, d, rng.w(), nullptr, 0, 6, "fuzz", fuzz);
        }
    } else {
        // Channel getters: directed streams + fuzz
        if (which == 0) {          // ch0 literal: word, +2
            static const uint16_t WV[] = {0x0000, 0x1234, 0xFFFF, 0x00FF};
            for (uint16_t w : WV) {
                uint8_t st2[2] = {(uint8_t)w, (uint8_t)(w >> 8)};
                CASE(0, 0, 0, st2, 2, 6, "grid", grid);
            }
        } else if (which == 1 || which == 3) {  // ch1/ch3: idx byte
            static const uint8_t IV[] = {0x00, 0x40, 0xBB, 0xFC, 0xFF};
            for (uint8_t ix : IV) {
                uint8_t st2[1] = {ix};
                CASE(0, 0, 0, st2, 1, 6, "grid", grid);
                CASE(0, 0, 0, st2, 1, 0, "grid", grid);   // [42]=0 variant
            }
        } else {                    // ch2 indirect: word address
            static const uint16_t AV[] = {0x0100, 0x008A, 0x158B, 0xFFFE};
            for (uint16_t adr : AV) {
                uint8_t st2[2] = {(uint8_t)adr, (uint8_t)(adr >> 8)};
                CASE(0, 0, 0, st2, 2, 6, "grid", grid);
            }
        }
        for (int i = 0; i < 300; i++) {
            uint8_t st2[2] = {(uint8_t)rng.next(), (uint8_t)rng.next()};
            CASE(0, 0, 0, st2, 2, (uint16_t)((rng.next() & 1) ? 6 : 0), "fuzz", fuzz);
        }
    }
...
int ft_selftest_op_unit(FtId id, uint32_t seed) {
    ...
    // ---- wave 4: accumulator family (acc lives at ds:8A) ----
    case FT_SUB_14646:                  // op 53: acc = [word DS addr]
        { static const uint8_t c[] = {0x53, 0x00, 0x05, 0x00}; A(c, 4, O, "grid"); }
        fuzz_op = 0x53; fuzz_alen = 3; break;
    case FT_SUB_14652: {                // op 54: acc = [LUT2[idx]+[1995]+14E5]
        FtWr wr[] = { { (uint16_t)(si + 0x1995), 2 } };
        static const uint8_t c[] = {0x54, 0x05, 0x00};
        A(c, 3, O, "grid", wr, 1);
        fuzz_op = 0x54; fuzz_alen = 2; break;
    }
    case FT_SUB_1466E:                  // op 55: acc = RNG (12312, seed at ds:8639)
        { static const uint8_t c[] = {0x55, 0x00}; A(c, 2, O, "grid"); }
        fuzz_op = 0x55; fuzz_alen = 1; break;
    case FT_SUB_14675:                  // op 96: [1995] = acc
        { static const uint8_t c[] = {0x96, 0x00}; A(c, 2, O, "grid"); }
        fuzz_op = 0x96; fuzz_alen = 1; break;
    case FT_SUB_14681: case FT_SUB_14686: {     // BC: acc<<=8 fallthrough; 56: [LUT+42+14E5]=acc
        uint8_t op = (id == FT_SUB_14681) ? 0xBC : 0x56;
        uint8_t c[] = {op, 0x05, 0x00};
        A(c, 3, O, "grid");
        fuzz_op = op; fuzz_alen = 2; break;
    }
    case FT_SUB_1469E: case FT_SUB_146A3: {     // BD: <<8 + 57; 57: [word addr] = acc
        uint8_t op = (id == FT_SUB_1469E) ? 0xBD : 0x57;
        uint8_t c[] = {op, 0x00, 0x05, 0x00};
        A(c, 4, O, "grid");
        fuzz_op = op; fuzz_alen = 3; break;
    }
    case FT_SUB_146AF: case FT_SUB_146B4: {     // BE: <<8 + 58; 58: [LUT+1995+14E5]=acc
        uint8_t op = (id == FT_SUB_146AF) ? 0xBE : 0x58;
        FtWr wr[] = { { (uint16_t)(si + 0x1995), 2 } };
        uint8_t c[] = {op, 0x05, 0x00};
        A(c, 3, O, "grid", wr, 1);
        fuzz_op = op; fuzz_alen = 2; break;
    }
    case FT_SUB_146D0: {                // op 90: flip redirect 59 <-> 5C
        static const uint8_t c[] = {0x90, 0x05, 0x00};
        A(c, 3, O, "grid");
        FtVmObj o2 = O; o2.flags = (uint16_t)(O.flags | 0x40);
        A(c, 3, o2, "grid");
        fuzz_op = 0x90; fuzz_alen = 2; break;
    }
    case FT_SUB_146DE:                  // op 59: [LUT+42+14E5] += acc
        { static const uint8_t c[] = {0x59, 0x05, 0x00}; A(c, 3, O, "grid"); }
        fuzz_op = 0x59; fuzz_alen = 2; break;
    case FT_SUB_146F6: {                // op 91: flip redirect 5A <-> 5D
        static const uint8_t c[] = {0x91, 0x05, 0x00};
        A(c, 3, O, "grid");
        FtVmObj o2 = O; o2.flags = (uint16_t)(O.flags | 0x40);
        A(c, 3, o2, "grid");
    ...
    // ---- wave 6: OR/XOR field ops + channel-compare jumps ----
    case FT_SUB_147E7:                  // op 62: [LUT2+[42]+14E5] |= acc
        { static const uint8_t c[] = {0x62, 0x05, 0x00}; A(c, 3, O, "grid"); }
        fuzz_op = 0x62; fuzz_alen = 2; break;
    case FT_SUB_147FF:                  // op 63: [word addr] |= acc
        { static const uint8_t c[] = {0x63, 0x00, 0x05, 0x00}; A(c, 4, O, "grid"); }
        fuzz_op = 0x63; fuzz_alen = 3; break;
    case FT_SUB_1480B: {                // op 64: partner field |= acc
        FtWr wr[] = { { (uint16_t)(si + 0x1995), 2 } };
        static const uint8_t c[] = {0x64, 0x05, 0x00};
        A(c, 3, O, "grid", wr, 1);
        fuzz_op = 0x64; fuzz_alen = 2; break;
    }
    case FT_SUB_14827:                  // op 65: [LUT2+[42]+14E5] ^= acc
        { static const uint8_t c[] = {0x65, 0x05, 0x00}; A(c, 3, O, "grid"); }
        fuzz_op = 0x65; fuzz_alen = 2; break;
    case FT_SUB_1483F:                  // op 66: [word addr] ^= acc
        { static const uint8_t c[] = {0x66, 0x00, 0x05, 0x00}; A(c, 4, O, "grid"); }
        fuzz_op = 0x66; fuzz_alen = 3; break;
    case FT_SUB_1484B: {                // op 67: partner field ^= acc
        FtWr wr[] = { { (uint16_t)(si + 0x1995), 2 } };
        static const uint8_t c[] = {0x67, 0x05, 0x00};
        A(c, 3, O, "grid", wr, 1);
        fuzz_op = 0x67; fuzz_alen = 2; break;
    }
    case FT_SUB_14867: case FT_SUB_14879: case FT_SUB_1488B:
    case FT_SUB_1489D: case FT_SUB_148AF: case FT_SUB_148C1:
    case FT_SUB_148D3: {
        // ops 68-6E: channel getter (1547e/15485/1549a/154a3/RNG) then
        // acc CMP result: JC/JNC branch -> jump or skip 2.
        uint8_t op = (id == FT_SUB_14867) ? 0x68 : (id == FT_SUB_14879) ? 0x69
                   : (id == FT_SUB_1488B) ? 0x6A : (id == FT_SUB_1489D) ? 0x6B
                   : (id == FT_SUB_148AF) ? 0x6C : (id == FT_SUB_148C1) ? 0x6D
                   : 0x6E;
        uint16_t t = FT_VM_PC + 0x40;
        // channel arg (consumed by the getter) + jump word
    ...
    case FT_SUB_14B2B:
    case FT_SUB_14B3B: {
        uint8_t op = (id == FT_SUB_149F3) ? 0x85 : (id == FT_SUB_14A0B) ? 0x72 : (id == FT_SUB_14A1B) ? 0x73 : (id == FT_SUB_14A2B) ? 0x74 : (id == FT_SUB_14A3B) ? 0x75 : (id == FT_SUB_14A4B) ? 0x76 : (id == FT_SUB_14A5B) ? 0x77 : (id == FT_SUB_14A6B) ? 0x78 : (id == FT_SUB_14A7B) ? 0x79 : (id == FT_SUB_14A8B) ? 0x7A : (id == FT_SUB_14A9B) ? 0x7B : (id == FT_SUB_14AAB) ? 0x86 : (id == FT_SUB_14ABB) ? 0x87 : (id == FT_SUB_14ACB) ? 0x88 : (id == FT_SUB_14ADB) ? 0x89 : (id == FT_SUB_14AEB) ? 0x8A : (id == FT_SUB_14AFB) ? 0x8B : (id == FT_SUB_14B0B) ? 0x8C : (id == FT_SUB_14B1B) ? 0x8D : (id == FT_SUB_14B2B) ? 0x8E : 0x8F;
        uint16_t t = FT_VM_PC + 0x40;
        uint8_t c[] = {op, 0x01, (uint8_t)t, (uint8_t)(t >> 8), 0x00};
        A(c, 5, O, "grid");
    ...
    case FT_SUB_14EBA:
    case FT_SUB_14ECA: {
        uint8_t op = (id == FT_SUB_14B4B) ? (uint8_t)0x97 : (id == FT_SUB_14B52) ? (uint8_t)0x98 : (id == FT_SUB_14B59) ? (uint8_t)0x99 : (id == FT_SUB_14B60) ? (uint8_t)0x9A : (id == FT_SUB_14B67) ? (uint8_t)0x9B : (id == FT_SUB_14B71) ? (uint8_t)0x9C : (id == FT_SUB_14BA7) ? (uint8_t)0x9D : (id == FT_SUB_14BCF) ? (uint8_t)0x9E : (id == FT_SUB_14C09) ? (uint8_t)0x9F : (id == FT_SUB_14C37) ? (uint8_t)0xA0 : (id == FT_SUB_14C59) ? (uint8_t)0xA1 : (id == FT_SUB_14C8D) ? (uint8_t)0xA5 : (id == FT_SUB_14CBB) ? (uint8_t)0xA6 : (id == FT_SUB_14CDD) ? (uint8_t)0xA7 : (id == FT_SUB_14D0F) ? (uint8_t)0xA2 : (id == FT_SUB_14D3D) ? (uint8_t)0xA3 : (id == FT_SUB_14D5F) ? (uint8_t)0xA4 : (id == FT_SUB_14D91) ? (uint8_t)0xA8 : (id == FT_SUB_14DA1) ? (uint8_t)0xA9 : (id == FT_SUB_14DB1) ? (uint8_t)0xAA : (id == FT_SUB_14DC1) ? (uint8_t)0xAB : (id == FT_SUB_14DD1) ? (uint8_t)0xAC : (id == FT_SUB_14DE4) ? (uint8_t)0xAD : (id == FT_SUB_14DF4) ? (uint8_t)0xAE : (id == FT_SUB_14E04) ? (uint8_t)0xAF : (id == FT_SUB_14E14) ? (uint8_t)0xB0 : (id == FT_SUB_14E24) ? (uint8_t)0xB1 : (id == FT_SUB_14E37) ? (uint8_t)0xB2 : (id == FT_SUB_14E47) ? (uint8_t)0xB3 : (id == FT_SUB_14E57) ? (uint8_t)0xB4 : (id == FT_SUB_14E67) ? (uint8_t)0xB5 : (id == FT_SUB_14E77) ? (uint8_t)0xB6 : (id == FT_SUB_14E8A) ? (uint8_t)0xB7 : (id == FT_SUB_14E9A) ? (uint8_t)0xB8 : (id == FT_SUB_14EAA) ? (uint8_t)0xB9 : (id == FT_SUB_14EBA) ? (uint8_t)0xBA : (uint8_t)0xBB;
        uint16_t t = FT_VM_PC + 0x40;
        // Universal frame: [op][01][t][t>>8][00] — shorter handlers treat the
...
int ft_selftest_op13(uint32_t seed) {
    ...
    // Coverage-directed (#47): al=0x01 → JZ loc_143eb → JMP loc_10e35 (the
    // DOS-exit / panning program entry). The oracle escapes via the INT21
    // guard (legal UB-skip), but the dispatch line itself executes; v2 hits
    // its fn-test _exit guard.
    {
        static const uint8_t c4[] = {0x13, 0x01, 0x00, 0x00, 0x00};
        ft_synth_case_vmop(0x13, c4 + 1, 4, O, seed ^ 9, "grid", grid, diff_budget, opf);
    }
...
// ---------------------------------------------------------------------------
// Wave B3a: pure/small 12xxx helpers.
// Delta scalers (1227e/122c0/122f3): exhaustive over all 65536 AX inputs,
// return compared on every case; the (write-free) DS image is rescanned on a
// 1/64 stride plus on any AX mismatch. sub_12312: RNG paths (LCG vs LFSR by
// ds:0x3CC) with seed grids and full DS compare. sub_12345: pair clear.
// sub_1237f: pure delay loop (contract: zero DS writes; di kept small).
extern "C" int16_t v2_fntest_call_delta(int which, int16_t d);
extern "C" uint16_t v2_fntest_call_rng_12312(uint8_t* shadow);
extern "C" void v2_fntest_call_clear_12345(uint8_t* shadow);

int ft_selftest_b3a(FtId id, uint32_t seed) {
    FtSynthStats grid, fuzz;
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    FtRng rng(seed);

    auto DSCAN = [&](const char* tag, uint16_t xin, FtSynthStats& st) -> long {
        long diffs = 0;
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_scratch[a] == g_synth_orig[a]) continue;
            if (v2_fntest_ds_skip(a)) continue;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[%s %s]: addr=%04X orig=%02X v2=%02X (in=%02X) | ax=%04X\n",
                        g_name[id], tag, a, g_synth_orig[a], g_scratch[a], g_synth_in[a], xin);
            diffs++;
        }
        (void)st;
        return diffs;
    ...
    if (id == FT_SUB_1227E || id == FT_SUB_122C0 || id == FT_SUB_122F3) {
        int which = (id == FT_SUB_1227E) ? 0 : (id == FT_SUB_122C0) ? 1 : 2;
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        for (uint32_t x = 0; x <= 0xFFFF; x++) {
            grid.cases++;
            memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
            uint16_t regs[8] = { (uint16_t)x, 0, 0, 0, 0, 0, 0, 0 };
            long esc0 = ft_ub_marks();
            v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
            if (ft_ub_marks() != esc0) { grid.cases--; continue; }
            uint16_t v2r = (uint16_t)v2_fntest_call_delta(which, (int16_t)x);
            long diffs = 0;
            if (regs[0] != v2r) {
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[%s exh]: AX in=%04X orig=%04X v2=%04X\n",
                            g_name[id], (uint16_t)x, regs[0], v2r);
                diffs++;
            }
            if ((x & 63) == 0 || diffs) {
                memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
                diffs += DSCAN("exh", (uint16_t)x, grid);
            }
            if (diffs) grid.fail++; else grid.pass++;
        }
    } else if (id == FT_SUB_12312) {
        static const uint32_t SEEDS[] = {0, 1, 0x15A4E35u, 0x7FFFFFFFu, 0x80000000u, 0xFFFFFFFFu};
        static const uint16_t T352[] = {0x0000, 0x0001, 0x8000, 0xA5C3, 0xFFFF};
        for (int p2 = 0; p2 < 2; p2++)
        for (uint32_t sd : SEEDS) for (uint16_t t : T352) {
            grid.cases++;
            memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
            ft_wr16(g_synth_in, 0x3CC, p2 ? 1 : 0);
            ft_wr16(g_synth_in, 0x352, t);
            *(uint32_t*)(g_synth_in + 0x8639) = sd;
            memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
            uint16_t regs[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
            long esc0 = ft_ub_marks();
            v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
            if (ft_ub_marks() != esc0) { grid.cases--; continue; }
            memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
            uint16_t v2r = v2_fntest_call_rng_12312(g_scratch);
            long diffs = (regs[0] != v2r) ? 1 : 0;
            if (diffs && diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_12312 grid]: AX orig=%04X v2=%04X (3CC=%d seed=%08X t=%04X)\n",
                        regs[0], v2r, p2, sd, t);
            diffs += DSCAN("grid", (uint16_t)sd, grid);
            if (diffs) grid.fail++; else grid.pass++;
        }
        for (int i = 0; i < 2000; i++) {
            fuzz.cases++;
            memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
            ft_wr16(g_synth_in, 0x3CC, rng.next() & 1);
            ft_wr16(g_synth_in, 0x352, rng.w());
            *(uint32_t*)(g_synth_in + 0x8639) = (uint32_t)rng.next() << 16 | rng.w();
            memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
            uint16_t regs[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
            long esc0 = ft_ub_marks();
            v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
            if (ft_ub_marks() != esc0) { fuzz.cases--; continue; }
            memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
            uint16_t v2r = v2_fntest_call_rng_12312(g_scratch);
            long diffs = (regs[0] != v2r) ? 1 : 0;
            diffs += DSCAN("fuzz", 0, fuzz);
            if (diffs) fuzz.fail++; else fuzz.pass++;
        }
    } else if (id == FT_SUB_12345) {
        static const uint16_t BG[] = {0x0000, 0x1234, 0xFFFF};
        for (uint16_t b : BG) {
            grid.cases++;
            memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
            ft_wr16(g_synth_in, 0x3B6, b);
            ft_wr16(g_synth_in, 0x3B8, (uint16_t)~b);
            memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
            uint16_t regs[8] = {0};
            long esc0 = ft_ub_marks();
            v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
            if (ft_ub_marks() != esc0) { grid.cases--; continue; }
            memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
            v2_fntest_call_clear_12345(g_scratch);
            long diffs = DSCAN("grid", b, grid);
            if (diffs) grid.fail++; else grid.pass++;
        }
    } else {   // FT_SUB_1237F: delay burn, no DS writes; v2 side is a no-op
        static const uint16_t DV1237F[] = {1, 2};
        for (uint16_t d : DV1237F) {
            grid.cases++;
            memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
            memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
            uint16_t regs[8] = { 0, 0, 0, 0, 0, d, 0, 0 };
            long esc0 = ft_ub_marks();
            v2_fntest_orig_isolated(v2_fntest_orig_fnptr(id), g_synth_orig, regs);
            if (ft_ub_marks() != esc0) { grid.cases--; continue; }
            memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
            long diffs = DSCAN("grid", d, grid);
            if (diffs) grid.fail++; else grid.pass++;
        }
    }
...
int ft_selftest_b3c1(FtId id, uint32_t seed) {
    ...
    if (id == FT_SUB_120FF) {
    ...
    } else if (id == FT_SUB_12D72) {
        // modes × counter/queue states; [3B6] keys, ESC bit, queue head/body.
        static const uint16_t MODES[] = {0, 1, 0x7FFF, 0x8000, 0x8001, 0x8002, 0xFFFF};
        static const uint16_t CNTS[] = {0, 1, 5};
        for (uint16_t md : MODES) for (uint16_t c3 : CNTS) for (int k = 0; k < 2; k++) {
            FtWr w[10]; int n = 0;
            w[n++] = FtWr{0x03CC, md};
            w[n++] = FtWr{0x03CE, c3};
            w[n++] = FtWr{0x03D0, 0x0042};
            w[n++] = FtWr{0x03B6, (uint16_t)(k ? 0x1042 : 0x0042)};
            w[n++] = FtWr{0x2191, 0x0008};
            w[n++] = FtWr{(uint16_t)(0x2191 + 8), 0x0303};
            w[n++] = FtWr{(uint16_t)(0x2193 + 8), 0x0004};
            w[n++] = FtWr{0x86DE, 0x8000};
            CASE(w, n, 0, "grid", grid);
        }
        // record path: keys change (flush branch, bx-not-reloaded artifact)
        for (uint16_t md : (const uint16_t[]){0x8003, 0xC000}) {
            FtWr w[8]; int n = 0;
            w[n++] = FtWr{0x03CC, md};
            w[n++] = FtWr{0x03CE, 3};
            w[n++] = FtWr{0x03D0, 0x0011};
            w[n++] = FtWr{0x03B6, 0x0022};
            w[n++] = FtWr{0x2191, 0x000C};
            CASE(w, n, 0, "grid", grid);
        }
        ...
        for (uint16_t al : ALIGNS) for (uint16_t tx : TEXTS) {
            ...
            w[n++] = FtWr{(uint16_t)(0x2200 + 0x1DAF), tx};
            CASE(w, n, 0x2200, "grid", grid);
        }
...
int ft_selftest_hudvga(FtId id, uint32_t seed) {
    ...
    case 8: {   // 11792: HUD chain — gate off / level 0x2C / on with mixed diffs
        ...
        for (int i = 0; i < 60; i++) {
            ...
            w[n++] = FtWr{0x25AD, 0x0001};
            w[n++] = FtWr{0x3C2, (uint16_t)((rng.next() % 3) * 2)};
            for (int vk = 0; vk < 3; vk++) {
                w[n++] = FtWr{(uint16_t)(0x16ED + vk * 2), rng.w()};
                w[n++] = FtWr{(uint16_t)(0x3E4 + vk * 4), (uint16_t)(rng.next() % 12)};
            }
            w[n++] = FtWr{0x414, (uint16_t)(rng.next() % 4)};
            w[n++] = FtWr{0x418, (uint16_t)(rng.next() % 4)};
            CASE(0, 0, 0, 0, w, n, "fuzz", fuzz);
...
// ---------------------------------------------------------------------------
// sub_12250: inventory category probe — CF + AX vs the oracle (io_regs[7] is
// the isolator's CF slot), plus full DS (read-only body).
extern "C" int v2_fntest_call_12250(uint8_t* shadow, uint16_t di, uint16_t* out_ax);

int ft_selftest_12250(uint32_t seed) {
    FtSynthStats grid, fuzz;
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    FtRng rng(seed);
    auto CASE = [&](uint16_t di, const FtWr* w, int nw, const char* tag, FtSynthStats& st) {
        st.cases++;
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        for (int i = 0; i < nw; i++) ft_wr16(g_synth_in, w[i].addr, w[i].val);
        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0, 0, 0, 0, 0, di, 0, 0 };
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_12250), g_synth_orig, regs);
        if (ft_ub_marks() != esc0) { st.cases--; return; }
        memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
        uint16_t v2_ax = 0;
        int v2_cf = v2_fntest_call_12250(g_scratch, di, &v2_ax);
        long diffs = 0;
        // orig: CLC = found (ax valid), STC = rejected — CF is the INVERSE
        // of the probe's "found" boolean.
        if ((regs[7] != 0) != (v2_cf == 0)) {
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_12250]: CF orig=%d v2-found=%d (di=%04X)\n",
                        regs[7] ? 1 : 0, v2_cf, di);
            diffs++;
        }
        if (v2_cf && regs[7] == 0 && regs[0] != v2_ax) {
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_12250]: AX orig=%04X v2=%04X (di=%04X)\n",
                        regs[0], v2_ax, di);
            diffs++;
        }
        for (uint32_t a = 0; a < 0x10000; a++) {
            ...
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_12250]: addr=%04X orig=%02X v2=%02X\n",
                        a, g_synth_orig[a], g_scratch[a]);
        }
        if (diffs) st.fail++; else st.pass++;
    };
    for (uint16_t di = 0; di <= 3; di++) for (int m = 0; m < 4; m++) {
        FtWr w[10]; int n = 0;
        w[n++] = FtWr{(uint16_t)(0x449 + (di & 1)), (uint16_t)((m & 1) ? 0x0101 : 0)};
    ...
    for (int i = 0; i < 200; i++) {
        FtWr w[12]; int n = 0;
        w[n++] = FtWr{0x449, rng.w()};
        w[n++] = FtWr{0x44B, rng.w()};
        for (int sl = 0; sl < 6; sl++)
            w[n++] = FtWr{(uint16_t)(0x3E4 + (rng.next() % 12) * 2), (uint16_t)(rng.next() % 6)};
        CASE((uint16_t)(rng.next() % 4), w, n, "fuzz", fuzz);
    }
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_12250]: grid %ld/%ld, fuzz %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, fuzz.pass, fuzz.cases,
        grid.cases + fuzz.cases, grid.fail + fuzz.fail,
        (grid.fail + fuzz.fail) ? "  <<< DIVERGENCE" : "");
    return (grid.fail + fuzz.fail) ? 1 : 0;
...
int ft_selftest_10e85(uint32_t seed) {
    ...
    long diff_budget = 16;
    FtRng rng(seed);
    auto CASE = [&](uint16_t es_in, uint16_t di_in, FtSynthStats& st) {
        st.cases++;
        memcpy(g_synth_orig, g_synth_base, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0x1234, 0x5678, 0, 0, 0x9ABC, di_in, 0, 0 };
        v2_fntest_es_override = es_in;
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_10E85), g_synth_orig, regs);
        v2_fntest_es_override = 0;
        if (ft_ub_marks() != esc0) { st.cases--; return; }
        long diffs = 0;
        uint16_t v2_es = v2_para_advance_10e85(es_in, di_in);
        if (v2_fntest_last_es != v2_es) {
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_10e85]: ES orig=%04X v2=%04X (es=%04X di=%04X)\n",
                        v2_fntest_last_es, v2_es, es_in, di_in);
            diffs++;
        }
        // orig: di=0 after; ax/bx preserved (PUSH/POP), si untouched.
        if (regs[5] != 0 || regs[0] != 0x1234 || regs[1] != 0x5678 || regs[4] != 0x9ABC) {
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_10e85]: regs ax=%04X bx=%04X si=%04X di=%04X\n",
                        regs[0], regs[1], regs[4], regs[5]);
            diffs++;
        }
        // register-pure: DS must be untouched.
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_synth_orig[a] == g_synth_base[a]) continue;
            if (v2_fntest_ds_skip(a)) continue;
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_10e85]: DS write addr=%04X val=%02X\n",
                        a, g_synth_orig[a]);
        }
        if (diffs) st.fail++; else st.pass++;
    };
    static const uint16_t DIS[] = { 0, 1, 0xF, 0x10, 0x11, 0x1F, 0x20, 0x8000, 0xFFF0, 0xFFFF };
    static const uint16_t ESS[] = { FT_VM_TESTSEG, 0x0100, 0xF000 };
    for (uint16_t e : ESS) for (uint16_t d : DIS) CASE(e, d, grid);
    for (int i = 0; i < 100; i++) CASE((uint16_t)(0x100 + (rng.next() % 0xE000)), rng.w(), fuzz);
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_10e85]: grid %ld/%ld, fuzz %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, fuzz.pass, fuzz.cases,
        grid.cases + fuzz.cases, grid.fail + fuzz.fail,
        (grid.fail + fuzz.fail) ? "  <<< DIVERGENCE" : "");
    return (grid.fail + fuzz.fail) ? 1 : 0;
...
// ---------------------------------------------------------------------------
// sub_1041c: password/quit-screen trigger. The four gates (viking selected,
// no transition, ESC edge, empty cmd buffer) are the diffable prefix: a
// closed gate returns with DS untouched; an open gate dives into the
// blocking pw loop (class L tail — sub_1047c/177bb/12352) which ESCAPES the
// isolator. So the diff criterion is: v2_pw_gate_1041c(s) == oracle-escaped.
extern "C" int v2_fntest_call_pw_gate(const uint8_t* shadow);

int ft_selftest_1041c(void) {
    FtSynthStats grid;
    long diff_budget = 12;
    v2_set_m2c_base(v2_fntest_m2c_base());
    auto CASE = [&](uint8_t sel, uint16_t fl334, uint16_t edges, uint16_t cmdw) {
        grid.cases++;
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        g_synth_in[0x25BA] = sel;
        ft_wr16(g_synth_in, 0x0334, fl334);
        ft_wr16(g_synth_in, 0x03B8, edges);
        ft_wr16(g_synth_in, 0x218F, cmdw);
        ft_fill_tail(g_synth_in);
        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_1041C), g_synth_orig, regs);
        bool orig_open = (ft_ub_marks() != esc0);   // escaped = dove into the L tail
        int v2_open = v2_fntest_call_pw_gate(g_synth_in);
        long diffs = 0;
        if ((v2_open != 0) != orig_open) {
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_1041c]: gate orig=%d v2=%d (sel=%02X fl=%04X ed=%04X cw=%04X)\n",
                        orig_open ? 1 : 0, v2_open, sel, fl334, edges, cmdw);
            diffs++;
        }
        if (!orig_open) {
            // closed-gate return must leave DS untouched
            for (uint32_t a = 0; a < 0x10000; a++) {
                if (g_synth_orig[a] == g_synth_in[a]) continue;
                if (v2_fntest_ds_skip(a)) continue;
                diffs++;
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[sub_1041c]: DS write addr=%04X val=%02X (closed gate)\n",
                            a, g_synth_orig[a]);
            }
        }
        if (diffs) grid.fail++; else grid.pass++;
        ...
        for (int fl = 0; fl <= 1; fl++)
            for (int ed = 0; ed <= 1; ed++)
                for (int cw = 0; cw <= 1; cw++)
                    CASE((uint8_t)(sel ? 2 : 0), (uint16_t)(fl ? 1 : 0),
                         (uint16_t)(ed ? 0x1000 : 0), (uint16_t)(cw ? 6 : 0));
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_1041c]: grid %ld/%ld — total cases=%ld fail=%ld%s\n",
...
// ---------------------------------------------------------------------------
// sub_105cb: password exit check — CF (regs[7]) + AX + full DS. The Y/N spec
// keys are LIVE sdl_spec_state atomics (both oracle and v2 read the same
// array), so cases preset them via direct stores and restore after.
extern "C" int v2_fntest_call_105cb(uint8_t* shadow, uint16_t* out_ax);

int ft_selftest_105cb(void) {
    FtSynthStats grid;
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    auto CASE = [&](uint16_t edges, uint16_t quit_active, int y_on, int n_on) {
        grid.cases++;
        sdl_spec_state[0x81].store(y_on ? 1 : 0, std::memory_order_relaxed);
        sdl_spec_state[0x9D].store(n_on ? 1 : 0, std::memory_order_relaxed);
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        ft_wr16(g_synth_in, 0x03B8, edges);
        ft_wr16(g_synth_in, 0x0443, quit_active);
        ft_wr16(g_synth_in, 0x0445, 0);
        ft_fill_tail(g_synth_in);
        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0xDEAD, 0, 0, 0, 0, 0, 0, 0 };
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_105CB), g_synth_orig, regs);
        if (ft_ub_marks() != esc0) { grid.cases--; goto restore; }
        {
            memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
            uint16_t v2_ax = 0xDEAD;
            int v2_cf = v2_fntest_call_105cb(g_scratch, &v2_ax);
            long diffs = 0;
            if ((regs[7] != 0) != (v2_cf != 0)) {
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[sub_105cb]: CF orig=%d v2=%d (ed=%04X qa=%04X y=%d n=%d)\n",
                            regs[7] ? 1 : 0, v2_cf, edges, quit_active, y_on, n_on);
                diffs++;
            }
            if (regs[7] && v2_cf && regs[0] != v2_ax) {
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[sub_105cb]: AX orig=%04X v2=%04X (ed=%04X qa=%04X)\n",
                            regs[0], v2_ax, edges, quit_active);
                diffs++;
            }
            for (uint32_t a = 0; a < 0x10000; a++) {
                if (g_scratch[a] == g_synth_orig[a]) continue;
                ...
                diffs++;
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[sub_105cb]: ds addr=%04X orig=%02X v2=%02X (ed=%04X qa=%04X y=%d n=%d)\n",
                            a, g_synth_orig[a], g_scratch[a], edges, quit_active, y_on, n_on);
            }
            if (diffs) grid.fail++; else grid.pass++;
        }
restore:
        sdl_spec_state[0x81].store(0, std::memory_order_relaxed);
        sdl_spec_state[0x9D].store(0, std::memory_order_relaxed);
    };
    static const uint16_t EDGES[] = { 0, 0x200, 0x100, 0x300, 0x8000, 0x1000, 0x8200, 0x1100, 0x9000 };
    static const uint16_t QA[] = { 0, 1, 2 };
    for (uint16_t e : EDGES) for (uint16_t q : QA) CASE(e, q, 0, 0);
    // Y/N live-key branches (incl. Y-beats-N ordering and Enter-beats-Y)
    CASE(0, 0, 1, 0); CASE(0, 1, 1, 0);
    CASE(0, 0, 0, 1); CASE(0, 1, 0, 1);
    CASE(0, 0, 1, 1);
    CASE(0x8000, 1, 1, 1); CASE(0x1000, 0, 1, 1);
    CASE(0x200, 1, 1, 0); CASE(0x100, 0, 0, 1);
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_105cb]: grid %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, grid.cases, grid.fail,
        grid.fail ? "  <<< DIVERGENCE" : "");
    return grid.fail ? 1 : 0;
}
...
// ---------------------------------------------------------------------------
// sub_111b1: template + level-descriptor loader. di = level. Level chunk id
// from the wrap-LUT [di*2-0x6BF4] (=0x940C), template id from [di*2-0x6B94]
// (=0x946C). Template: skipped when 0xFFFF or equal to the [2E71] cache,
// else LZSS via sub_10982 into es=[2E67]; then the level chunk decompresses
// INTO DS at 0x25B3 (es=ds tail-JMP). Compare: dest zone + full DS (the DS
// decompression lands inside the scanned image).
extern "C" void v2_fntest_call_111b1(uint8_t* shadow);

int ft_selftest_111b1(void) {
    FtSynthStats grid;
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    if (!v2_fntest_set_data_file("DATA.DAT") || !v2_fntest_set_data_file_v2("DATA.DAT")) {
        fprintf(stderr, "FNSELFTEST-SUMMARY[sub_111b1]: DATA.DAT missing — total cases=0 fail=1\n");
        return 1;
    }
    uint8_t* mbase = (uint8_t*)v2_fntest_m2c_base();
    uint8_t* dest_zone = mbase + (uint32_t)FT_DEST_SEG * 16;
    static uint8_t saved_dest[0x10000], orig_dest[0x10000];
    auto CASE = [&](uint16_t level, uint16_t tmpl_cache) {
        grid.cases++;
        memcpy(saved_dest, dest_zone, 0x10000);
        memset(dest_zone, 0xCC, 0x10000);
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        ft_wr16(g_synth_in, DS_SEG_ANIM, FT_DEST_SEG);      // es target [2E67]
        ft_wr16(g_synth_in, DS_TEMPLATE_CHUNK, tmpl_cache); // [2E71] cache
        ft_wr16(g_synth_in, DS_SEG_FS, 0x7800);             // LZSS ring — NOT the
        // dest zone: FT_FS_SEG aliases FT_DEST_SEG (0x5800) and the ring
        // writes would trash the oracle's decompressed template.
        ft_wr16(g_synth_in, DS_LEVEL_LOAD, level);          // v2 reads this
        for (int i = 0; i < 10; i++) g_synth_in[DS_CHUNK_HDR + i] = 0;
        ft_fill_tail(g_synth_in);
        uint16_t saved_10980 = v2_fntest_get_word_10980();
        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0, 0, 0, 0, 0, level, 0, 0 };  // oracle takes DI
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_111B1), g_synth_orig, regs);
        v2_fntest_put_word_10980(saved_10980);
        if (ft_ub_marks() != esc0) {
            grid.cases--;
            fprintf(stderr, "FNSELFTEST-UB[sub_111b1]: escaped (level=%u)\n", level);
            memcpy(dest_zone, saved_dest, 0x10000);
            return;
        }
        memcpy(orig_dest, dest_zone, 0x10000);
        memcpy(dest_zone, saved_dest, 0x10000);
        memset(v2_vm_get_shadow_animdata(), 0xCC, 0x10000);
        memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
        v2_fntest_call_111b1(g_scratch);
        long diffs = 0;
        uint8_t* v2z = v2_vm_get_shadow_animdata();
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (orig_dest[a] == v2z[a]) continue;
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_111b1]: tmpl+%04X orig=%02X v2=%02X (level=%u)\n",
                        a, orig_dest[a], v2z[a], level);
            if (diffs > 40) break;
        }
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_scratch[a] == g_synth_orig[a]) continue;
            ...
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_111b1]: ds addr=%04X orig=%02X v2=%02X (level=%u)\n",
                        a, g_synth_orig[a], g_scratch[a], level);
        }
        if (diffs) grid.fail++; else grid.pass++;
    };
    CASE(0, 0);        // template fresh (cache miss)
    CASE(0, 0xFFFF);   // cache value differs, template loads
    CASE(1, 0);
    CASE(2, 0);
    // cache-hit: preload the cache with level 0's template id from the base LUT
    {
        uint16_t t0 = (uint16_t)(g_synth_base[0x946C] | (g_synth_base[0x946D] << 8));
        CASE(0, t0);   // template skipped, only level chunk into DS
    }
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_111b1]: grid %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, grid.cases, grid.fail,
        grid.fail ? "  <<< DIVERGENCE" : "");
    return grid.fail ? 1 : 0;
}
...
// ---------------------------------------------------------------------------
// sub_11439: render gate — if !( [25CF] & 0x42 ) call sub_16DED (band render,
// unit 136 channel: tilegfx TESTSEG + FS ring + K3 VGA compare), then the
// tail-JMP sub_16775 page flip (m2c: set_display_memory_addr; v2:
// v2_page_flip_16775 — DS fields land in the DS scan).
extern "C" void v2_fntest_call_11439(uint8_t* shadow);

int ft_selftest_11439(uint32_t seed) {
    FtSynthStats grid;
    long diff_budget = 24;
    FtRng rng(seed);
    v2_set_m2c_base(v2_fntest_m2c_base());
    ...
    auto CASE = [&](uint8_t flags) {
        ...
        memcpy(v2_fntest_fs_ptr(), fz, 0x10000);
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        g_synth_in[DS_LEVEL_FLAGS] = flags;
        ft_wr16(g_synth_in, DS_SEG_TILEGFX, FT_VM_TESTSEG);
        ft_wr16(g_synth_in, DS_SEG_FS, FT_FS_SEG);
        ft_wr16(g_synth_in, DS_FS_PAGE_STRIDE, 0x00AC);
        ...
        v2_fntest_fs_override = FT_FS_SEG;
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_11439), g_synth_orig, regs);
        v2_fntest_fs_override = 0;
        bool esc = ft_ub_marks() != esc0;
        memcpy(a000, saved_a000, 0x10000);
        memcpy(fz, saved_fz, 0x10000);
        if (esc) {
            grid.cases--;
            memcpy(tz, saved_tz, 0x10000);
            fprintf(stderr, "FNSELFTEST-UB[sub_11439]: escaped (flags=%02X)\n", flags);
            return;
        }
        memset(vga, 0xCC, 65536 * 4);
        memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
        v2_fntest_call_11439(g_scratch);
        memcpy(tz, saved_tz, 0x10000);
        long diffs = 0;
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_scratch[a] == g_synth_orig[a]) continue;
            ...
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_11439]: ds addr=%04X orig=%02X v2=%02X (flags=%02X)\n",
                        a, g_synth_orig[a], g_scratch[a], flags);
        }
        for (uint32_t a = 0; a < 65536u * 4; a++) {
            if (db[a] == vga[a]) continue;
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_11439]: vga lin=%06X orig=%02X v2=%02X (flags=%02X)\n",
                        a, db[a], vga[a], flags);
            if (diffs > 40) break;
        }
        if (diffs) grid.fail++; else grid.pass++;
    };
    CASE(0x00);  // gate open: 16DED band + flip
    CASE(0x02);  // gate closed (bit 1)
    CASE(0x40);  // gate closed (bit 6)
    CASE(0x42);  // gate closed (both)
    CASE(0x01);  // gate open (bit 0 is not in the mask)
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_11439]: grid %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, grid.cases, grid.fail,
        grid.fail ? "  <<< DIVERGENCE" : "");
    return grid.fail ? 1 : 0;
}
...
// ---- Unit sub_11204: level chunk-load dispatcher ([25CF] bits 2/20/40) ----
// Branches: &2 → 4 raw chunks via sub_10cd8 (cur,cur,cur,0x180 at VGA offsets
// 20C8/66A8/AC88/0); &0x40 → same with 0x213 tail; &0x20 → 0x211 then falls
// into the tile path; else tile path: 3×sub_10982 LZSS into [2E5F]/[2E61]/
// [2E63] segments + [2E65]=di-out + tail-JMP sub_10982 into [2E5D].
// Oracle dest zones are synthetic segments in m2c::m; v2 writes its shadow
// buffers. Compare: full DS + per-branch dest-zone contents (0xCC baseline).
extern "C" void v2_fntest_call_11204(uint8_t* shadow);

static int ft_selftest_11204(void) {
    FtSynthStats grid;
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    if (!v2_fntest_set_data_file("DATA.DAT") || !v2_fntest_set_data_file_v2("DATA.DAT")) {
        fprintf(stderr, "FNSELFTEST-SUMMARY[sub_11204]: DATA.DAT missing — total cases=0 fail=1\n");
        return 1;
    }
    // Oracle segment layout (paragraphs): chunk 64K, then 4 tile dests 16K
    // each, then the FS ring zone.
    const uint16_t SEG_CHUNK = 0x5800;                    // 64K  @0x58000
    const uint16_t SEG_TGFX = 0x6800, SEG_GS = 0x6C00;    // 16K each
    const uint16_t SEG_TMAP = 0x7000, SEG_TDAT = 0x7400;
    const uint16_t SEG_FS   = 0x7800;                     // ring+comp window
    uint8_t* mbase = (uint8_t*)v2_fntest_m2c_base();
    static uint8_t saved[0x24000];      // 0x58000..0x7C000 window save
    static uint8_t orig_zone[0x24000];
    auto CASE = [&](uint16_t flags, uint16_t cur, uint16_t tile, uint16_t bg) {
        grid.cases++;
        memcpy(saved, mbase + 0x58000, 0x24000);
        memset(mbase + 0x58000, 0xCC, 0x24000);
        memcpy(g_synth_in, g_synth_base, sizeof(g_synth_in));
        g_synth_in[DS_LEVEL_FLAGS] = (uint8_t)flags;
        ft_wr16(g_synth_in, DS_CHUNK_CUR, cur);
        ft_wr16(g_synth_in, DS_CHUNK_TILE, tile);
        ft_wr16(g_synth_in, DS_CHUNK_BG, bg);
        ft_wr16(g_synth_in, DS_SEG_CHUNK, SEG_CHUNK);
        ft_wr16(g_synth_in, DS_SEG_TILEGFX, SEG_TGFX);
        ft_wr16(g_synth_in, DS_SEG_GS, SEG_GS);
        ft_wr16(g_synth_in, DS_SEG_TILEMAP, SEG_TMAP);
        ft_wr16(g_synth_in, DS_SEG_TILEDATA, SEG_TDAT);
        ft_wr16(g_synth_in, DS_SEG_FS, SEG_FS);
        for (int i = 0; i < 10; i++) g_synth_in[DS_CHUNK_HDR + i] = 0;
        ft_fill_tail(g_synth_in);
        uint16_t saved_10980 = v2_fntest_get_word_10980();
        memcpy(g_synth_orig, g_synth_in, sizeof(g_synth_orig));
        uint16_t regs[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
        long esc0 = ft_ub_marks();
        v2_fntest_orig_isolated(v2_fntest_orig_fnptr(FT_SUB_11204), g_synth_orig, regs);
        v2_fntest_put_word_10980(saved_10980);
        if (ft_ub_marks() != esc0) {
            grid.cases--;
            fprintf(stderr, "FNSELFTEST-UB[sub_11204]: escaped (flags=%02X)\n", flags);
            memcpy(mbase + 0x58000, saved, 0x24000);
            return;
        }
        memcpy(orig_zone, mbase + 0x58000, 0x24000);
        memcpy(mbase + 0x58000, saved, 0x24000);
        // --- v2 ---
        memset(v2_vm_get_shadow_chunk(), 0xCC, 0x10000);
        memset(v2_vm_get_shadow_tilegfx(), 0xCC, 0x4000);
        memset(v2_vm_get_shadow_gs(), 0xCC, 0x4000);
        memset(v2_vm_get_shadow_tilemap(), 0xCC, 0x4000);
        memset(v2_vm_get_shadow_gs_tiledata(), 0xCC, 0x4000);
        memcpy(g_scratch, g_synth_in, sizeof(g_scratch));
        v2_fntest_call_11204(g_scratch);
        long diffs = 0;
        auto ZONE = [&](uint32_t lin_off, const uint8_t* v2p, uint32_t len, const char* zn) {
            for (uint32_t a = 0; a < len; a++) {
                if (orig_zone[lin_off + a] == v2p[a]) continue;
                diffs++;
                if (diff_budget-- > 0)
                    fprintf(stderr, "FNSELFTEST-DIFF[sub_11204]: %s+%04X orig=%02X v2=%02X (flags=%02X)\n",
                            zn, a, orig_zone[lin_off + a], v2p[a], flags);
                if (diffs > 40) return;
            }
        };
        if (flags & 2 || (flags & 0x40)) {
            ZONE(0x00000, v2_vm_get_shadow_chunk(), 0x10000, "chunk");
        } else {
            if (flags & 0x20) ZONE(0x00000, v2_vm_get_shadow_chunk(), 0x10000, "chunk");
            ZONE(0x10000, v2_vm_get_shadow_tilegfx(), 0x4000, "tilegfx");
            ZONE(0x14000, v2_vm_get_shadow_gs(), 0x4000, "gs");
            ZONE(0x18000, v2_vm_get_shadow_tilemap(), 0x4000, "tilemap");
            ZONE(0x1C000, v2_vm_get_shadow_gs_tiledata(), 0x4000, "gs_tiledata");
        }
        for (uint32_t a = 0; a < 0x10000; a++) {
            if (g_scratch[a] == g_synth_orig[a]) continue;
            if (v2_fntest_ds_skip(a)) continue;
            diffs++;
            if (diff_budget-- > 0)
                fprintf(stderr, "FNSELFTEST-DIFF[sub_11204]: ds addr=%04X orig=%02X v2=%02X (flags=%02X)\n",
                        a, g_synth_orig[a], g_scratch[a], flags);
        }
        if (diffs) grid.fail++; else grid.pass++;
    };
    CASE(0x02, 0x180, 3, 6);   // intro type 1: raw chunks only
    CASE(0x40, 0x180, 3, 6);   // intro type 2 (0x213 tail)
    CASE(0x20, 3, 3, 6);       // HUD-only 0x211 + tile path
    CASE(0x00, 3, 3, 6);       // pure tile path
    CASE(0x00, 5, 5, 4);       // tile path, other corpus ids
    fprintf(stderr,
        "FNSELFTEST-SUMMARY[sub_11204]: grid %ld/%ld — total cases=%ld fail=%ld%s\n",
        grid.pass, grid.cases, grid.cases, grid.fail,
        grid.fail ? "  <<< DIVERGENCE" : "");
    return grid.fail ? 1 : 0;
}
...
int ft_selftest_dosio(FtId id, uint32_t seed) {
    ...
    long diff_budget = 24;
    v2_set_m2c_base(v2_fntest_m2c_base());
    // FNSELFTEST skips m2c::init: hand the memmgr a real MCB chain so the
    // INT21/48-4A family allocates honestly instead of hanging on garbage.
    static bool meminit_done = false;
    if (!meminit_done) { v2_fntest_meminit(); meminit_done = true; }
    ...
    case FT_SUB_12EF8: {
        ...
        // exact [32882] loop remainder depends on the LOOPE interleave.
        v2_fntest_set_in201(0xFE);   // bit0 low -> ah=2 path (TEST ah,1 == 0)
        {   static const FtWr w[] = { {0x86DA,1},{0xA39E,0x20},
                                      {0x86D2,0x30},{0x86D4,0x10},
                                      {0x86D6,0x30},{0x86D8,0x10},{0x3CC,0} };
            CASE(w,7,r0,nullptr,0,"axis-x");
        }
        v2_fntest_set_in201(0xFD);   // bit1 low -> ah=1 path (TEST ah,1 != 0)
        {   static const FtWr w[] = { {0x86DA,1},{0xA39E,0x20},
                                      {0x86D2,0x30},{0x86D4,0x10},
                                      {0x86D6,0x30},{0x86D8,0x10},{0x3CC,0} };
    ...
    case FT_SUB_12948: {
        ...
        // With the MCB chain initialized the whole startup runs clean:
        // SETBLOCK resize (error CF ignored by the orig), vector get/set
        // stubs -> [86AC/AE]=0, 16528, fixed INT21/2C time -> [8639/863B].
        {   static const Exp e[] = { {0x86AC,0},{0x86AE,0},
                                     {0x8639,0x5678},{0x863B,0x1234} };
            CASE(nullptr,0,r0,e,4,"startup");
        }
        ::v2_fntest_es_override = 0;
        break;
    }
    case FT_SUB_12989: {
        ...
        // no-op, bx=cx=0) must equal [86C2]; then [302]/[304] are seeded
        // from the CHECKSUM DERIVATIVE at 2A1C/2A22 (a copy-protection
        // fingerprint, NOT a config copy); INT10/1A00 VGA detect, the
        ...
        {   // (#60 LEDGER-MODEL) the 12AB8@2AF8 skip arm needs bit15 in
            // BOTH [302] and [304] — but 2A1C/2A22 overwrite them with the
            // deterministic checksum derivative of the model (BIOS sum +
            // INT21/30 + INT21/36 constants), whose bit pattern is fixed.
            // The arm is live only on real hardware fingerprints; in the
            // model it is documented one-sided. Exercise the chain anyway.
            static const FtWr w[] = { {0x86D0,0},{0x86C2,0x3000},
    ...
    case FT_SUB_128A9: {
        ...
        // defer arm: the orig IRQ0 ISR sets cs:128A8 while DOS is busy —
        // the asm.cpp INT21 model reproduces that under this flag.
        v2_fntest_sim_int21_irq = 1;
        CASE(nullptr,0,r,nullptr,0,"irq-defer");
        v2_fntest_sim_int21_irq = 0;
        break;
    }
    case FT_SUB_10D96: {
        // bytes->paras head folds into 10d9f's alloc: ax:bx = byte count.
        FtRegs r{}; r.ax = 0; r.bx = 0x100;   // 0x11 paras: clean alloc
        CASE(nullptr,0,r,nullptr,0,"alloc-small");
        break;
    }
    case FT_SUB_10D9F: {
        {   FtRegs r{}; r.bx = 1;             // 1 para: clean alloc
            CASE(nullptr,0,r,nullptr,0,"alloc-1");
        }
        {   // request over the whole heap: CF -> JC -> sub_10dba fatal
            // (INT21/4C isolator escape) — the 10da6 arm executes.
            FtRegs r{}; r.bx = 0xFFFF;
    ...
    case FT_SUB_108C8: {
        ...
        {   // (#60 branch) [302]&[304]&0x8000 -> the 8D2 entry-gate RETN
            static const FtWr w[] = { {0x302,0x8000},{0x304,0x8000} };
            static const Exp e[] = { {0,0} };
            CASE(w,2,r0,e,0,"busy");
        }
        {   // (#60 branch) ALT+M with a busy stream: the 941 XOR makes
            // [302]=0x8001 (low byte 1 -> 946 taken), then 10959 TEST
            // bit15 fires the 95F RETN.
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_press_latch[0x9E] = 1;
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,0x8000},{0x304,0} };
            CASE(w,2,r0,nullptr,0,"unmute-busy");
        }
        {   // both keys down; [304] low byte 0 -> XOR makes it 1 (mute ON)
            ...
            sdl_spec_press_latch[0x8B] = 1;   // S   (0x918B)
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,1},{0x304,0},
                                      {0x990C,0x1234},{0x990E,0x1234} };
            CASE(w,4,r0,nullptr,0,"mute-on");
        }
        {   // [304] low byte 1 -> XOR clears it (mute OFF) -> the 10935 arm
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_press_latch[0x8B] = 1;
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,1},{0x304,1},
                                      {0x990C,0xFFFF},{0x990E,0x1234} };
            CASE(w,4,r0,nullptr,0,"mute-off");
        }
        {   // F10 without S but with M -> the 935 music-mute toggle ON
            // ([302] low byte XOR -> 1: the 10959 arm)
            sdl_spec_press_latch[0xA4] = 1;   // F10
            sdl_spec_press_latch[0x9E] = 1;   // M (0x919E)
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,0},{0x304,0} };
            CASE(w,2,r0,nullptr,0,"music-off-toggle");
        }
        {   // music-mute toggle OFF -> the 948 restart chain
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_press_latch[0x9E] = 1;
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,1},{0x304,0} };
        ...
        {   // F10 without S -> the 10935 arm
            ...
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,1},{0x304,1} };
            CASE(w,2,r0,nullptr,0,"f10-only");
        }
        {   // AIL busy gate ([302]&[304]&0x8000) -> early ret
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0x302,0x8000},{0x304,0x8000} };
            static const Exp e[] = { {0,0} };
    ...
    case FT_SUB_17337: {
        // MDA debug print: writes text into the 0xB000 window of m2c::m —
        // never called by the game (dead in the port), but the body is a
        // plain near routine: exercising it is honest execution.
        CASE(nullptr,0,r0,nullptr,0,"print");
        {   // cursor past the MDA page bottom -> the 73b4 wrap arm
            static const FtWr w[] = { {0x9343,0x0C80} };
            CASE(w,1,r0,nullptr,0,"print-wrap");
        }
        break;
    }
    case FT_SUB_172D3: {
        // Far twin: the CALL_ model handles the RETF tail cleanly.
        CASE(nullptr,0,r0,nullptr,0,"print-far");
        break;
    }
    case FT_SUB_11BA5: {
        // TAB pause/inventory loop. Gates: [25CF]&1 + [3B8]&0x2000; the
        // loop body re-reads input via sub_12352 each iter — seed the SDL
        // input word so 11cbb's Enter arm returns CF=1 and the loop exits.
        // Exercise-only: the iter body is a whole frame chain (11cbb/11c52/
        // 11792/16775/10130/108c8) — the per-call diff units own those.
        extern uint16_t input_keys;
        uint16_t keep = input_keys;
        input_keys = 0x8000;                    // action/Enter bit
        static const FtWr w[] = { {0x25CF,0x0089},{0x3B8,0x2000},
                                  {0xA39C,0x0000},{0x3C2,0},
                                  {0x1A85,0x0008},{0x0304,1},
                                  {0x3E4,1},{0x414,1},{0x449,0x0101},
                                  {0x92FF,1} };
    ...
    case FT_SUB_10350: {
        // Quit-prompt gates. The entry inline REWRITES the spec DS bytes
        // from the SDL frame snap — so the presses must come through the
        // latch channel (like 108c8), not DS presets. The open paths run
        ...
        // sub_105cb exit with CF=1, so the WHOLE chain unwinds — 104a1's
        // exit arms, 103ca's return tail and 10350's 3c6 jump all execute.
        input_keys = 0x8000;
        {   // F10 + ALT-X -> 366/36b arms + prompt chain; the Y latch stays
            // visible in the frozen snap (no frame_begin consume in the
            // isolator), so sub_105cb answers the prompt with CF=1 and the
            // whole chain unwinds through 104a1's exit arms + 103ca's tail.
            sdl_spec_press_latch[0xA4] = 1;   // F10
            sdl_spec_press_latch[0x99] = 1;   // X
            sdl_spec_press_latch[0x81] = 1;   // Y (0x9181) — prompt answer
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x92FF,1} };
            CASE(w,2,r0,nullptr,0,"altx-open");
        }
        {   // special mode ([3CC]=0x8000) -> the 37c arm of the open path
            sdl_spec_press_latch[0xB0] = 1;   // ESC spec byte
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x3CC,0x8000},{0x92FF,1} };
            CASE(w,3,r0,nullptr,0,"special-open");
        }
        {   // shading already active ([342]!=0) -> the 3b5 tail-jump
            sdl_spec_press_latch[0xB0] = 1;
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x342,1},{0x92FF,1} };
            CASE(w,3,r0,nullptr,0,"shaded-tail");
        }
        {   // F10 alone -> the 372 reject: entry inline stores the snap
            // values, nothing else changes.
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_snapshot_take();
            Exp e[1] = { {0x91A4, 0x0001} };
            CASE(nullptr,0,r0,e,1,"f10-only-ret");
        }
        {   // F10 + ALT-Q -> 36d/372 arms + prompt chain
            sdl_spec_press_latch[0xA4] = 1;   // F10
            sdl_spec_press_latch[0x7C] = 1;   // Q
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x92FF,1} };
            CASE(w,2,r0,nullptr,0,"altq-open");
        }
        {   // N answer: sub_105cb exits with ax=0 -> the 4fa OR [28814],2
            // arm and 103ca's 418 JMP 10e35 tail (clean unwind).
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_press_latch[0x99] = 1;
            sdl_spec_press_latch[0x9D] = 1;   // N (0x919D)
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x92FF,1} };
            CASE(w,2,r0,nullptr,0,"altx-no");
        }
        {   // no prompt answer at all: the loop spins (4ee back-jump runs)
            // until the watchdog — expected escape.
            input_keys = 0;
            sdl_spec_press_latch[0xA4] = 1;
            sdl_spec_press_latch[0x99] = 1;
            sdl_spec_snapshot_take();
        ...
        {   // (#60 branch) ALT+X prompt answered with ESC: sub_105cb's
            ...
            // (#60) the prompt loop's FIRST 12352 refreshes the snap and
            // the consumed ESC latch vanishes before 105cb reads it - ESC
        ...
        {   // [25CF] bit3 set -> the 386 JMP 10e35 top-level bail
            sdl_spec_press_latch[0xB0] = 1;
            sdl_spec_snapshot_take();
            static const FtWr w[] = { {0xA39C,0},{0x25CF,0x0008} };
            CASE(w,2,r0,nullptr,0,"bit3-bail",1);
        }
        input_keys = keep_keys;
        sdl_spec_snapshot_take();   // consume leftovers
        break;
    }
    case FT_SUB_1754C: {
        // AIL timer stop: the far CALLF into the converted driver body
        // runs and returns cleanly (the m2c AIL conversion is live).
        {   static const FtWr w[] = { {0xA39A,1} };
            CASE(w,1,r0,nullptr,0,"stop");
        }
        {   static const FtWr w[] = { {0xA39A,0} };
            static const Exp e[] = { {0,0} };
            CASE(w,1,r0,e,0,"skip");
        }
        {   // (#60 branch) [302]!=0 with [304]==0: the 7920 JZ takes the
            // 17924 continue arm instead of the 7922 early return.
            static const FtWr w[] = { {0xA39A,1},{0x302,1},{0x304,0} };
            CASE(w,3,r0,nullptr,0,"half-busy");
        }
        break;
    }
    case FT_SUB_17561: {
        // AIL shutdown chain: the converted far driver calls run cleanly.
        {   static const FtWr w[] = { {0x302,0},{0x304,0} };
            CASE(w,2,r0,nullptr,0,"shutdown");
        }
    ...
    case FT_SUB_16440: {
        ...
        {   // (#60 branch) S make-code (0x1F -> si=0x3E): the 646E fall
            // into the F10-held test (6470), F10 latch clear -> 6475 fall.
            v2_fntest_set_in60(0x1F);
            CASE(nullptr,0,r0,nullptr,0,"spec-s",1);
        }
        {   // (#60 branch) S with F10 held ([91A4]=1): the 6475 JNZ skip
            // of the mask/ASCII writes (the mute-combo arm).
            v2_fntest_set_in60(0x1F);
            static const FtWr w[] = { {0x91A4,1} };
            CASE(w,1,r0,nullptr,0,"spec-s-f10",1);
        }
        {   // (#60 branch) partial debug chord: F10 latch held but R/D
            // latches clear -> the 64A3 JNZ reject after the 649C fall.
            v2_fntest_set_in60(0x1E);
    ...
    case FT_SUB_11080: {
        ...
        v2_fntest_set_data_file("DATA.DAT");
        v2_fntest_set_data_file_v2("DATA.DAT");
        // (#60) the 114E gate reads [25AD] AFTER the 113B-113F reload
        // copies [25C9] into it - seed the TARGET level, not the current.
        {   static const FtWr w[] = { {0x25C9,0x25},{0xA39C,0},{0x92FF,1} };
            CASE(w,3,r0,nullptr,0,"lvl37",1);
        }
        {   static const FtWr w[] = { {0x25C9,2},{0xA39C,0},{0x92FF,1} };
    ...
    case FT_SUB_17791: {
        // ambient music restart gate: [302]&0x8000 -> the 7797 skip;
        // [302] nonzero without bit15 -> the 77A2 skip; zero -> restart.
        {   static const FtWr w[] = { {0x302,0x8000} };
            static const Exp e[] = { {0,0} };
            CASE(w,1,r0,e,0,"busy-bit15");
        }
        {   static const FtWr w[] = { {0x302,1},{0x304,0} };
            static const Exp e[] = { {0,0} };
            CASE(w,2,r0,e,0,"busy-low");
        }
        {   static const FtWr w[] = { {0x302,0},{0x304,0},{0x2E6B,0} };
            CASE(w,3,r0,nullptr,0,"restart");
        }
        break;
    }
    case FT_SUB_17A44: {
    ...
    case FT_SUB_100BB: {
        ...
        {   // (#60 branch) cheats enabled but neither F5 nor F6 held:
            // the 10B and 126 rejects both fall to the 1012D exit.
            static const FtWr w[] = { {0xA39C,0},{0x92FF,1},{0x202,1},
                                      {0x25AD,5} };
            CASE(w,4,r0,nullptr,0,"cheat-idle",1);
        }
...
extern "C" int v2_fntest_selftest_env(void) {
    ...
    if (all || strstr(env, "sub_12fc6")) { matched = true; rc |= ft_selftest_deltafam(FT_SUB_12FC6, ft_seed(0x12FC6001u)); }
    if (all || strstr(env, "sub_12fcb")) { matched = true; rc |= ft_selftest_deltafam(FT_SUB_12FCB, ft_seed(0x12FCB001u)); }
    if (all || strstr(env, "sub_12fd0")) { matched = true; rc |= ft_selftest_deltafam(FT_SUB_12FD0, ft_seed(0x12FD0001u)); }
    if (all || strstr(env, "sub_158aa")) { matched = true; rc |= ft_selftest_search(FT_SUB_158AA, ft_seed(0x158AA001u)); }
    if (all || strstr(env, "sub_158b9")) { matched = true; rc |= ft_selftest_search(FT_SUB_158B9, ft_seed(0x158B9001u)); }
    if (all || strstr(env, "sub_158c8")) { matched = true; rc |= ft_selftest_search(FT_SUB_158C8, ft_seed(0x158C8001u)); }
    if (all || strstr(env, "sub_158d7")) { matched = true; rc |= ft_selftest_search(FT_SUB_158D7, ft_seed(0x158D7001u)); }
    if (all || strstr(env, "sub_158e6")) { matched = true; rc |= ft_selftest_search(FT_SUB_158E6, ft_seed(0x158E6001u)); }
    if (all || strstr(env, "sub_1303a")) { matched = true; rc |= ft_selftest_anim(FT_SUB_1303A, ft_seed(0x1303A001u)); }
    ...
    if (all || strstr(env, "sub_1614e")) { matched = true; rc |= ft_selftest_scan(FT_SUB_1614E, ft_seed(0x1614E001u)); }
    if (all || strstr(env, "sub_15c37")) { matched = true; rc |= ft_selftest_scan(FT_SUB_15C37, ft_seed(0x15C37001u)); }
    if (all || strstr(env, "sub_15c93")) { matched = true; rc |= ft_selftest_scan(FT_SUB_15C93, ft_seed(0x15C93001u)); }
    if (all || strstr(env, "sub_15afd")) { matched = true; rc |= ft_selftest_scan(FT_SUB_15AFD, ft_seed(0x15AFD001u)); }
    if (all || strstr(env, "sub_10982")) { matched = true; rc |= ft_selftest_chunk(ft_seed(0x10982001u)); }
    if (all || strstr(env, "sub_10cd8")) { matched = true; rc |= ft_selftest_rawchunk(ft_seed(0x10CD8001u)); }
    if (all || strstr(env, "sub_10fe6")) { matched = true; rc |= ft_selftest_pal(FT_SUB_10FE6, ft_seed(0x10FE6001u)); }
    if (all || strstr(env, "sub_10ffc")) { matched = true; rc |= ft_selftest_pal(FT_SUB_10FFC, ft_seed(0x10FFC001u)); }
    ...
    if (all || strstr(env, "sub_12515")) { matched = true; rc |= ft_selftest_textcfg(FT_SUB_12515, ft_seed(0x12515001u)); }
    if (all || strstr(env, "sub_12529")) { matched = true; rc |= ft_selftest_textcfg(FT_SUB_12529, ft_seed(0x12529001u)); }
    ...
    if (all || strstr(env, "sub_15cef")) { matched = true; rc |= ft_selftest_bbox_vel(FT_SUB_15CEF, ft_seed(0x15CEF001u)); }
    if (all || strstr(env, "sub_15cf5")) { matched = true; rc |= ft_selftest_bbox_vel(FT_SUB_15CF5, ft_seed(0x15CF5001u)); }
    if (all || strstr(env, "sub_15de5")) { matched = true; rc |= ft_selftest_objscan_x(FT_SUB_15DE5, ft_seed(0x15DE5001u)); }
    if (all || strstr(env, "sub_15df2")) { matched = true; rc |= ft_selftest_objscan_x(FT_SUB_15DF2, ft_seed(0x15DF2001u)); }
    if (all || strstr(env, "sub_15fb1")) { matched = true; rc |= ft_selftest_objscan_y(FT_SUB_15FB1, ft_seed(0x15FB1001u)); }
    if (all || strstr(env, "sub_15fbe")) { matched = true; rc |= ft_selftest_objscan_y(FT_SUB_15FBE, ft_seed(0x15FBE001u)); }
    if (all || strstr(env, "sub_1603e")) { matched = true; rc |= ft_selftest_probe_1603e(ft_seed(0x1603E001u)); }
    if (all || strstr(env, "sub_160cf")) { matched = true; rc |= ft_selftest_atpos(FT_SUB_160CF, ft_seed(0x160CF001u)); }
    if (all || strstr(env, "sub_15ae9")) { matched = true; rc |= ft_selftest_atpos(FT_SUB_15AE9, ft_seed(0x15AE9001u)); }
    if (all || strstr(env, "sub_1589b")) { matched = true; rc |= ft_selftest_atpos(FT_SUB_1589B, ft_seed(0x1589B001u)); }
    if (all || strstr(env, "sub_159c6")) { matched = true; rc |= ft_selftest_tilewalk(FT_SUB_159C6, ft_seed(0x159C6001u)); }
    if (all || strstr(env, "sub_159d3")) { matched = true; rc |= ft_selftest_tilewalk(FT_SUB_159D3, ft_seed(0x159D3001u)); }
    if (all || strstr(env, "sub_159df")) { matched = true; rc |= ft_selftest_tilewalk(FT_SUB_159DF, ft_seed(0x159DF001u)); }
    if (all || strstr(env, "sub_15a57")) { matched = true; rc |= ft_selftest_tilewalk(FT_SUB_15A57, ft_seed(0x15A57001u)); }
    if (all || strstr(env, "sub_15ac4")) { matched = true; rc |= ft_selftest_tilewalk(FT_SUB_15AC4, ft_seed(0x15AC4001u)); }
    if (all || strstr(env, "sub_158f5")) { matched = true; rc |= ft_selftest_sub_158f5(ft_seed(0x158F5001u)); }
    if (all || strstr(env, "sub_1592d")) { matched = true; rc |= ft_selftest_sub_1592d(ft_seed(0x1592D001u)); }
    if (all || strstr(env, "sub_15505")) { matched = true; rc |= ft_selftest_sub_15505(ft_seed(0x15505001u)); }
    if (all || strstr(env, "sub_15517")) { matched = true; rc |= ft_selftest_sub_15517(ft_seed(0x15517001u)); }
    if (all || strstr(env, "sub_1555c")) { matched = true; rc |= ft_selftest_coll_pass(FT_SUB_1555C, ft_seed(0x1555C001u)); }
    if (all || strstr(env, "sub_15569")) { matched = true; rc |= ft_selftest_coll_pass(FT_SUB_15569, ft_seed(0x15569001u)); }
    if (all || strstr(env, "sub_15530")) { matched = true; rc |= ft_selftest_coll_sweep(FT_SUB_15530, ft_seed(0x15530001u)); }
    if (all || strstr(env, "sub_15546")) { matched = true; rc |= ft_selftest_coll_sweep(FT_SUB_15546, ft_seed(0x15546001u)); }
    if (all || strstr(env, "sub_155d6")) { matched = true; rc |= ft_selftest_coll_check(FT_SUB_155D6, ft_seed(0x155D6001u)); }
    if (all || strstr(env, "sub_156c0")) { matched = true; rc |= ft_selftest_coll_check(FT_SUB_156C0, ft_seed(0x156C0001u)); }
    if (all || strstr(env, "sub_1584e")) { matched = true; rc |= ft_selftest_coll_dir(FT_SUB_1584E, ft_seed(0x1584E001u)); }
    if (all || strstr(env, "sub_157eb")) { matched = true; rc |= ft_selftest_coll_dir(FT_SUB_157EB, ft_seed(0x157EB001u)); }
    if (all || strstr(env, "sub_16235")) { matched = true; rc |= ft_selftest_colltab(FT_SUB_16235, ft_seed(0x16235001u)); }
    if (all || strstr(env, "sub_16243")) { matched = true; rc |= ft_selftest_colltab(FT_SUB_16243, ft_seed(0x16243001u)); }
    if (all || strstr(env, "sub_16390")) { matched = true; rc |= ft_selftest_sub_16390(ft_seed(0x16390001u)); }
    if (all || strstr(env, "sub_163ac")) { matched = true; rc |= ft_selftest_sub_163ac(ft_seed(0x163AC001u)); }
    if (all || strstr(env, "sub_153ea")) { matched = true; rc |= ft_selftest_bittest(FT_SUB_153EA, ft_seed(0x153EA001u)); }
    if (all || strstr(env, "sub_15403")) { matched = true; rc |= ft_selftest_bittest(FT_SUB_15403, ft_seed(0x15403001u)); }
    if (all || strstr(env, "sub_1542a")) { matched = true; rc |= ft_selftest_bittest(FT_SUB_1542A, ft_seed(0x1542A001u)); }
    if (all || strstr(env, "sub_15445")) { matched = true; rc |= ft_selftest_bittest(FT_SUB_15445, ft_seed(0x15445001u)); }
    if (all || strstr(env, "sub_15473")) { matched = true; rc |= ft_selftest_chan(FT_SUB_15473, ft_seed(0x15473001u)); }
    if (all || strstr(env, "sub_15470")) { matched = true; rc |= ft_selftest_chan(FT_SUB_15470, ft_seed(0x15470001u)); }
    if (all || strstr(env, "sub_154bf")) { matched = true; rc |= ft_selftest_chan(FT_SUB_154BF, ft_seed(0x154BF001u)); }
    if (all || strstr(env, "sub_15788")) { matched = true; rc |= ft_selftest_sub_15788(ft_seed(0x15788001u)); }
    if (all || strstr(env, "sub_136a0")) { matched = true; rc |= ft_selftest_flip(FT_SUB_136A0, ft_seed(0x136A0001u)); }
    if (all || strstr(env, "sub_13757")) { matched = true; rc |= ft_selftest_flip(FT_SUB_13757, ft_seed(0x13757001u)); }
    if (all || strstr(env, "sub_1386b")) { matched = true; rc |= ft_selftest_sub_1386b(ft_seed(0x1386B001u)); }
    if (all || strstr(env, "sub_1625d")) { matched = true; rc |= ft_selftest_sub_1625d(ft_seed(0x1625D001u)); }
    if (all || strstr(env, "sub_13916")) { matched = true; rc |= ft_selftest_sub_13916(ft_seed(0x13916001u)); }
    if (all || strstr(env, "sub_12fe5")) { matched = true; rc |= ft_selftest_sub_12fe5(ft_seed(0x12FE5001u)); }
    if (all || strstr(env, "sub_13c93")) { matched = true; rc |= ft_selftest_sub_13c93(ft_seed(0x13C93001u)); }
    if (all || strstr(env, "sub_13d30")) { matched = true; rc |= ft_selftest_spawn_gate(FT_SUB_13D30, ft_seed(0x13D30001u)); }
    if (all || strstr(env, "sub_13d52")) { matched = true; rc |= ft_selftest_spawn_gate(FT_SUB_13D52, ft_seed(0x13D52001u)); }
    if (all || strstr(env, "sub_12f82")) { matched = true; rc |= ft_selftest_sub_12f82(ft_seed(0x12F82001u)); }
    if (all || strstr(env, "sub_13e52")) { matched = true; rc |= ft_selftest_sub_13e52(ft_seed(0x13E52001u)); }
    if (all || strstr(env, "sub_13809")) { matched = true; rc |= ft_selftest_sub_13809(ft_seed(0x13809001u)); }
    if (all || strstr(env, "sub_13bbd")) { matched = true; rc |= ft_selftest_sub_13bbd(ft_seed(0x13BBD001u)); }
    if (all || strstr(env, "sub_13fc2")) { matched = true; rc |= ft_selftest_sub_13fc2(ft_seed(0x13FC2001u)); }
    if (all || strstr(env, "sub_139ef")) { matched = true; rc |= ft_selftest_sub_139ef(ft_seed(0x139EF001u)); }
    if (all || strstr(env, "sub_13a14")) { matched = true; rc |= ft_selftest_spawn_band(FT_SUB_13A14, ft_seed(0x13A14001u)); }
    if (all || strstr(env, "sub_13a34")) { matched = true; rc |= ft_selftest_spawn_band(FT_SUB_13A34, ft_seed(0x13A34001u)); }
    if (all || strstr(env, "sub_1689e")) { matched = true; rc |= ft_selftest_sub_1689e(ft_seed(0x1689E001u)); }
    if (all || strstr(env, "sub_16dc1")) { matched = true; rc |= ft_selftest_tile_loop(FT_SUB_16DC1, ft_seed(0x16DC1001u)); }
    if (all || strstr(env, "sub_16dd9")) { matched = true; rc |= ft_selftest_tile_loop(FT_SUB_16DD9, ft_seed(0x16DD9001u)); }
    if (all || strstr(env, "sub_1712b")) { matched = true; rc |= ft_selftest_sub_1712b(ft_seed(0x1712B001u)); }
    if (all || strstr(env, "sub_171dc")) { matched = true; rc |= ft_selftest_sub_171dc(ft_seed(0x171DC001u)); }
    if (all || strstr(env, "sub_16ded")) { matched = true; rc |= ft_selftest_sub_16ded(ft_seed(0x16DED001u)); }
    if (all || strstr(env, "sub_16e75")) { matched = true; rc |= ft_selftest_scroll_band(FT_SUB_16E75, ft_seed(0x16E75001u)); }
    if (all || strstr(env, "sub_16f5f")) { matched = true; rc |= ft_selftest_scroll_band(FT_SUB_16F5F, ft_seed(0x16F5F001u)); }
    if (all || strstr(env, "sub_17049")) { matched = true; rc |= ft_selftest_scroll_band(FT_SUB_17049, ft_seed(0x17049001u)); }
    if (all || strstr(env, "sub_170b9")) { matched = true; rc |= ft_selftest_scroll_band(FT_SUB_170B9, ft_seed(0x170B9001u)); }
    if (all || strstr(env, "sub_13ae0")) { matched = true; rc |= ft_selftest_sub_13ae0(ft_seed(0x13AE0001u)); }
    if (all || strstr(env, "sub_141f7")) { matched = true; rc |= ft_selftest_pc_bump(FT_SUB_141F7, ft_seed(0x141F7001u)); }
    if (all || strstr(env, "sub_141fb")) { matched = true; rc |= ft_selftest_pc_bump(FT_SUB_141FB, ft_seed(0x141FB001u)); }
    if (all || strstr(env, "sub_141ff")) { matched = true; rc |= ft_selftest_pc_bump(FT_SUB_141FF, ft_seed(0x141FF001u)); }
    if (all || strstr(env, "sub_14203")) { matched = true; rc |= ft_selftest_pc_bump(FT_SUB_14203, ft_seed(0x14203001u)); }
    if (all || strstr(env, "sub_165aa")) { matched = true; rc |= ft_selftest_sub_165aa(ft_seed(0x165AA001u)); }
    if (all || strstr(env, "sub_166e8")) { matched = true; rc |= ft_selftest_dirty_mark(FT_SUB_166E8, ft_seed(0x166E8001u)); }
    if (all || strstr(env, "sub_16710")) { matched = true; rc |= ft_selftest_dirty_mark(FT_SUB_16710, ft_seed(0x16710001u)); }
    if (all || strstr(env, "sub_16661")) { matched = true; rc |= ft_selftest_sub_16661(ft_seed(0x16661001u)); }
    if (all || strstr(env, "sub_1673c")) { matched = true; rc |= ft_selftest_sub_1673c(ft_seed(0x1673C001u)); }
    if (all || strstr(env, "sub_1406d")) { matched = true; rc |= ft_selftest_sub_1406d(ft_seed(0x1406D001u)); }
    if (all || strstr(env, "sub_13084")) { matched = true; rc |= ft_selftest_sub_13084(ft_seed(0x13084001u)); }
    if (all || strstr(env, "sub_135cf")) { matched = true; rc |= ft_selftest_sub_135cf(ft_seed(0x135CF001u)); }
    if (all || strstr(env, "sub_142b7")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142B7, ft_seed(0x142B7001u)); }
    if (all || strstr(env, "sub_142c0")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142C0, ft_seed(0x142C0001u)); }
    if (all || strstr(env, "sub_142cf")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142CF, ft_seed(0x142CF001u)); }
    if (all || strstr(env, "sub_142c1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142C1, ft_seed(0x142C1001u)); }
    if (all || strstr(env, "sub_142d3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142D3, ft_seed(0x142D3001u)); }
    if (all || strstr(env, "sub_142dc")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142DC, ft_seed(0x142DC001u)); }
    if (all || strstr(env, "sub_142fc")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_142FC, ft_seed(0x142FC001u)); }
    if (all || strstr(env, "sub_1431c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1431C, ft_seed(0x1431C001u)); }
    if (all || strstr(env, "sub_14327")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14327, ft_seed(0x14327001u)); }
    if (all || strstr(env, "sub_14334")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14334, ft_seed(0x14334001u)); }
    if (all || strstr(env, "sub_14340")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14340, ft_seed(0x14340001u)); }
    if (all || strstr(env, "sub_141f6")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_141F6, ft_seed(0x141F6001u)); }
    if (all || strstr(env, "sub_143f2")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_143F2, ft_seed(0x143F2001u)); }
    if (all || strstr(env, "sub_143fe")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_143FE, ft_seed(0x143FE001u)); }
    if (all || strstr(env, "sub_14409")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14409, ft_seed(0x14409001u)); }
    if (all || strstr(env, "sub_14428")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14428, ft_seed(0x14428001u)); }
    if (all || strstr(env, "sub_1443d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1443D, ft_seed(0x1443D001u)); }
    if (all || strstr(env, "sub_1444f")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1444F, ft_seed(0x1444F001u)); }
    if (all || strstr(env, "sub_14453")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14453, ft_seed(0x14453001u)); }
    if (all || strstr(env, "sub_14469")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14469, ft_seed(0x14469001u)); }
    if (all || strstr(env, "sub_1446d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1446D, ft_seed(0x1446D001u)); }
    if (all || strstr(env, "sub_14483")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14483, ft_seed(0x14483001u)); }
    if (all || strstr(env, "sub_14487")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14487, ft_seed(0x14487001u)); }
    if (all || strstr(env, "sub_144a9")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_144A9, ft_seed(0x144A9001u)); }
    if (all || strstr(env, "sub_144ad")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_144AD, ft_seed(0x144AD001u)); }
    if (all || strstr(env, "sub_144cf")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_144CF, ft_seed(0x144CF001u)); }
    if (all || strstr(env, "sub_144d3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_144D3, ft_seed(0x144D3001u)); }
    if (all || strstr(env, "sub_144fd")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_144FD, ft_seed(0x144FD001u)); }
    if (all || strstr(env, "sub_14501")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14501, ft_seed(0x14501001u)); }
    if (all || strstr(env, "sub_14532")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14532, ft_seed(0x14532001u)); }
    if (all || strstr(env, "sub_14561")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14561, ft_seed(0x14561001u)); }
    if (all || strstr(env, "sub_14590")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14590, ft_seed(0x14590001u)); }
    if (all || strstr(env, "sub_145b5")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_145B5, ft_seed(0x145B5001u)); }
    if (all || strstr(env, "sub_145da")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_145DA, ft_seed(0x145DA001u)); }
    if (all || strstr(env, "sub_145e5")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_145E5, ft_seed(0x145E5001u)); }
    if (all || strstr(env, "sub_14604")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14604, ft_seed(0x14604001u)); }
    if (all || strstr(env, "sub_14624")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14624, ft_seed(0x14624001u)); }
    if (all || strstr(env, "sub_1462e")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1462E, ft_seed(0x1462E001u)); }
    if (all || strstr(env, "sub_14646")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14646, ft_seed(0x14646001u)); }
    if (all || strstr(env, "sub_14652")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14652, ft_seed(0x14652001u)); }
    if (all || strstr(env, "sub_1466e")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1466E, ft_seed(0x1466E001u)); }
    if (all || strstr(env, "sub_14675")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14675, ft_seed(0x14675001u)); }
    if (all || strstr(env, "sub_14681")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14681, ft_seed(0x14681001u)); }
    if (all || strstr(env, "sub_14686")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14686, ft_seed(0x14686001u)); }
    if (all || strstr(env, "sub_1469e")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1469E, ft_seed(0x1469E001u)); }
    if (all || strstr(env, "sub_146a3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146A3, ft_seed(0x146A3001u)); }
    if (all || strstr(env, "sub_146af")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146AF, ft_seed(0x146AF001u)); }
    if (all || strstr(env, "sub_146b4")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146B4, ft_seed(0x146B4001u)); }
    if (all || strstr(env, "sub_146d0")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146D0, ft_seed(0x146D0001u)); }
    if (all || strstr(env, "sub_146de")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146DE, ft_seed(0x146DE001u)); }
    if (all || strstr(env, "sub_146f6")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_146F6, ft_seed(0x146F6001u)); }
    if (all || strstr(env, "sub_14704")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14704, ft_seed(0x14704001u)); }
    if (all || strstr(env, "sub_14713")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14713, ft_seed(0x14713001u)); }
    if (all || strstr(env, "sub_14721")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14721, ft_seed(0x14721001u)); }
    if (all || strstr(env, "sub_1473d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1473D, ft_seed(0x1473D001u)); }
    if (all || strstr(env, "sub_1474b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1474B, ft_seed(0x1474B001u)); }
    if (all || strstr(env, "sub_14763")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14763, ft_seed(0x14763001u)); }
    if (all || strstr(env, "sub_14771")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14771, ft_seed(0x14771001u)); }
    if (all || strstr(env, "sub_1477d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1477D, ft_seed(0x1477D001u)); }
    if (all || strstr(env, "sub_1478b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1478B, ft_seed(0x1478B001u)); }
    if (all || strstr(env, "sub_147a7")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_147A7, ft_seed(0x147A7001u)); }
    if (all || strstr(env, "sub_147bf")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_147BF, ft_seed(0x147BF001u)); }
    if (all || strstr(env, "sub_147cb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_147CB, ft_seed(0x147CB001u)); }
    if (all || strstr(env, "sub_147e7")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_147E7, ft_seed(0x147E7001u)); }
    if (all || strstr(env, "sub_147ff")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_147FF, ft_seed(0x147FF001u)); }
    if (all || strstr(env, "sub_1480b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1480B, ft_seed(0x1480B001u)); }
    if (all || strstr(env, "sub_14827")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14827, ft_seed(0x14827001u)); }
    if (all || strstr(env, "sub_1483f")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1483F, ft_seed(0x1483F001u)); }
    if (all || strstr(env, "sub_1484b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1484B, ft_seed(0x1484B001u)); }
    if (all || strstr(env, "sub_14867")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14867, ft_seed(0x14867001u)); }
    if (all || strstr(env, "sub_14879")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14879, ft_seed(0x14879001u)); }
    if (all || strstr(env, "sub_1488b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1488B, ft_seed(0x1488B001u)); }
    if (all || strstr(env, "sub_1489d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1489D, ft_seed(0x1489D001u)); }
    if (all || strstr(env, "sub_148af")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_148AF, ft_seed(0x148AF001u)); }
    if (all || strstr(env, "sub_148c1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_148C1, ft_seed(0x148C1001u)); }
    if (all || strstr(env, "sub_148d3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_148D3, ft_seed(0x148D3001u)); }
    if (all || strstr(env, "sub_148e5")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_148E5, ft_seed(0x148E5001u)); }
    if (all || strstr(env, "sub_148f7")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_148F7, ft_seed(0x148F7001u)); }
    if (all || strstr(env, "sub_14909")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14909, ft_seed(0x14909001u)); }
    if (all || strstr(env, "sub_1491b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1491B, ft_seed(0x1491B001u)); }
    if (all || strstr(env, "sub_14933")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14933, ft_seed(0x14933001u)); }
    if (all || strstr(env, "sub_1494b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1494B, ft_seed(0x1494B001u)); }
    if (all || strstr(env, "sub_14963")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14963, ft_seed(0x14963001u)); }
    if (all || strstr(env, "sub_1497b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1497B, ft_seed(0x1497B001u)); }
    if (all || strstr(env, "sub_14993")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14993, ft_seed(0x14993001u)); }
    if (all || strstr(env, "sub_149ab")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_149AB, ft_seed(0x149AB001u)); }
    if (all || strstr(env, "sub_149c3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_149C3, ft_seed(0x149C3001u)); }
    if (all || strstr(env, "sub_149db")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_149DB, ft_seed(0x149DB001u)); }
    if (all || strstr(env, "sub_149f3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_149F3, ft_seed(0x149F3001u)); }
    if (all || strstr(env, "sub_14a0b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A0B, ft_seed(0x14A0B001u)); }
    if (all || strstr(env, "sub_14a1b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A1B, ft_seed(0x14A1B001u)); }
    if (all || strstr(env, "sub_14a2b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A2B, ft_seed(0x14A2B001u)); }
    if (all || strstr(env, "sub_14a3b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A3B, ft_seed(0x14A3B001u)); }
    if (all || strstr(env, "sub_14a4b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A4B, ft_seed(0x14A4B001u)); }
    if (all || strstr(env, "sub_14a5b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A5B, ft_seed(0x14A5B001u)); }
    if (all || strstr(env, "sub_14a6b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A6B, ft_seed(0x14A6B001u)); }
    if (all || strstr(env, "sub_14a7b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A7B, ft_seed(0x14A7B001u)); }
    if (all || strstr(env, "sub_14a8b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A8B, ft_seed(0x14A8B001u)); }
    if (all || strstr(env, "sub_14a9b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14A9B, ft_seed(0x14A9B001u)); }
    if (all || strstr(env, "sub_14aab")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14AAB, ft_seed(0x14AAB001u)); }
    if (all || strstr(env, "sub_14abb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14ABB, ft_seed(0x14ABB001u)); }
    if (all || strstr(env, "sub_14acb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14ACB, ft_seed(0x14ACB001u)); }
    if (all || strstr(env, "sub_14adb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14ADB, ft_seed(0x14ADB001u)); }
    if (all || strstr(env, "sub_14aeb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14AEB, ft_seed(0x14AEB001u)); }
    if (all || strstr(env, "sub_14afb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14AFB, ft_seed(0x14AFB001u)); }
    if (all || strstr(env, "sub_14b0b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B0B, ft_seed(0x14B0B001u)); }
    if (all || strstr(env, "sub_14b1b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B1B, ft_seed(0x14B1B001u)); }
    if (all || strstr(env, "sub_14b2b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B2B, ft_seed(0x14B2B001u)); }
    if (all || strstr(env, "sub_14b3b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B3B, ft_seed(0x14B3B001u)); }
    if (all || strstr(env, "sub_14b4b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B4B, ft_seed(0x14B4B001u)); }
    if (all || strstr(env, "sub_14b52")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B52, ft_seed(0x14B52001u)); }
    if (all || strstr(env, "sub_14b59")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B59, ft_seed(0x14B59001u)); }
    if (all || strstr(env, "sub_14b60")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B60, ft_seed(0x14B60001u)); }
    if (all || strstr(env, "sub_14b67")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B67, ft_seed(0x14B67001u)); }
    if (all || strstr(env, "sub_14b71")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14B71, ft_seed(0x14B71001u)); }
    if (all || strstr(env, "sub_14ba7")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14BA7, ft_seed(0x14BA7001u)); }
    if (all || strstr(env, "sub_14bcf")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14BCF, ft_seed(0x14BCF001u)); }
    if (all || strstr(env, "sub_14c09")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14C09, ft_seed(0x14C09001u)); }
    if (all || strstr(env, "sub_14c37")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14C37, ft_seed(0x14C37001u)); }
    if (all || strstr(env, "sub_14c59")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14C59, ft_seed(0x14C59001u)); }
    if (all || strstr(env, "sub_14c8d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14C8D, ft_seed(0x14C8D001u)); }
    if (all || strstr(env, "sub_14cbb")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14CBB, ft_seed(0x14CBB001u)); }
    if (all || strstr(env, "sub_14cdd")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14CDD, ft_seed(0x14CDD001u)); }
    if (all || strstr(env, "sub_14d0f")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14D0F, ft_seed(0x14D0F001u)); }
    if (all || strstr(env, "sub_14d3d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14D3D, ft_seed(0x14D3D001u)); }
    if (all || strstr(env, "sub_14d5f")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14D5F, ft_seed(0x14D5F001u)); }
    if (all || strstr(env, "sub_14d91")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14D91, ft_seed(0x14D91001u)); }
    if (all || strstr(env, "sub_14da1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DA1, ft_seed(0x14DA1001u)); }
    if (all || strstr(env, "sub_14db1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DB1, ft_seed(0x14DB1001u)); }
    if (all || strstr(env, "sub_14dc1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DC1, ft_seed(0x14DC1001u)); }
    if (all || strstr(env, "sub_14dd1")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DD1, ft_seed(0x14DD1001u)); }
    if (all || strstr(env, "sub_14de4")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DE4, ft_seed(0x14DE4001u)); }
    if (all || strstr(env, "sub_14df4")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14DF4, ft_seed(0x14DF4001u)); }
    if (all || strstr(env, "sub_14e04")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E04, ft_seed(0x14E04001u)); }
    if (all || strstr(env, "sub_14e14")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E14, ft_seed(0x14E14001u)); }
    if (all || strstr(env, "sub_14e24")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E24, ft_seed(0x14E24001u)); }
    if (all || strstr(env, "sub_14e37")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E37, ft_seed(0x14E37001u)); }
    if (all || strstr(env, "sub_14e47")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E47, ft_seed(0x14E47001u)); }
    if (all || strstr(env, "sub_14e57")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E57, ft_seed(0x14E57001u)); }
    if (all || strstr(env, "sub_14e67")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E67, ft_seed(0x14E67001u)); }
    if (all || strstr(env, "sub_14e77")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E77, ft_seed(0x14E77001u)); }
    if (all || strstr(env, "sub_14e8a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E8A, ft_seed(0x14E8A001u)); }
    if (all || strstr(env, "sub_14e9a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14E9A, ft_seed(0x14E9A001u)); }
    if (all || strstr(env, "sub_14eaa")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14EAA, ft_seed(0x14EAA001u)); }
    if (all || strstr(env, "sub_14eba")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14EBA, ft_seed(0x14EBA001u)); }
    if (all || strstr(env, "sub_14eca")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14ECA, ft_seed(0x14ECA001u)); }
    if (all || strstr(env, "sub_14edd")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14EDD, ft_seed(0x9000001u)); }
    if (all || strstr(env, "sub_14f09")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14F09, ft_seed(0x9001001u)); }
    if (all || strstr(env, "sub_14f27")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14F27, ft_seed(0x9002001u)); }
    if (all || strstr(env, "sub_14f59")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14F59, ft_seed(0x9003001u)); }
    if (all || strstr(env, "sub_14fc4")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14FC4, ft_seed(0x9004001u)); }
    if (all || strstr(env, "sub_14fc8")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14FC8, ft_seed(0x9005001u)); }
    if (all || strstr(env, "sub_14fec")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_14FEC, ft_seed(0x9006001u)); }
    if (all || strstr(env, "sub_15017")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15017, ft_seed(0x9007001u)); }
    if (all || strstr(env, "sub_15039")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15039, ft_seed(0x9008001u)); }
    if (all || strstr(env, "sub_15078")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15078, ft_seed(0x9009001u)); }
    if (all || strstr(env, "sub_150b5")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_150B5, ft_seed(0x9010001u)); }
    if (all || strstr(env, "sub_150fc")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_150FC, ft_seed(0x9011001u)); }
    if (all || strstr(env, "sub_15106")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15106, ft_seed(0x9012001u)); }
    if (all || strstr(env, "sub_1515c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1515C, ft_seed(0x9013001u)); }
    if (all || strstr(env, "sub_15160")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15160, ft_seed(0x9014001u)); }
    if (all || strstr(env, "sub_1518a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1518A, ft_seed(0x9015001u)); }
    if (all || strstr(env, "sub_1518e")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1518E, ft_seed(0x9016001u)); }
    if (all || strstr(env, "sub_151b8")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_151B8, ft_seed(0x9017001u)); }
    if (all || strstr(env, "sub_151bc")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_151BC, ft_seed(0x9018001u)); }
    if (all || strstr(env, "sub_151f2")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_151F2, ft_seed(0x9019001u)); }
    if (all || strstr(env, "sub_151f6")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_151F6, ft_seed(0x9020001u)); }
    if (all || strstr(env, "sub_1522c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1522C, ft_seed(0x9021001u)); }
    if (all || strstr(env, "sub_1524a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1524A, ft_seed(0x9022001u)); }
    if (all || strstr(env, "sub_15268")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15268, ft_seed(0x9023001u)); }
    if (all || strstr(env, "sub_1527b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1527B, ft_seed(0x9024001u)); }
    if (all || strstr(env, "sub_1529a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1529A, ft_seed(0x9025001u)); }
    if (all || strstr(env, "sub_152b3")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_152B3, ft_seed(0x9026001u)); }
    if (all || strstr(env, "sub_152c6")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_152C6, ft_seed(0x9027001u)); }
    if (all || strstr(env, "sub_152ca")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_152CA, ft_seed(0x9028001u)); }
    if (all || strstr(env, "sub_152d6")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_152D6, ft_seed(0x9029001u)); }
    if (all || strstr(env, "sub_152de")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_152DE, ft_seed(0x9030001u)); }
    if (all || strstr(env, "sub_1531c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1531C, ft_seed(0x9031001u)); }
    if (all || strstr(env, "sub_1559c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1559C, ft_seed(0x9032001u)); }
    if (all || strstr(env, "sub_155c0")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_155C0, ft_seed(0x9033001u)); }
    if (all || strstr(env, "sub_15686")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15686, ft_seed(0x9034001u)); }
    if (all || strstr(env, "sub_156aa")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_156AA, ft_seed(0x9035001u)); }
    if (all || strstr(env, "sub_15772")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15772, ft_seed(0x9036001u)); }
    if (all || strstr(env, "sub_157d5")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_157D5, ft_seed(0x9037001u)); }
    if (all || strstr(env, "sub_15838")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15838, ft_seed(0x9038001u)); }
    if (all || strstr(env, "sub_15e7c")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15E7C, ft_seed(0x9039001u)); }
    if (all || strstr(env, "sub_15e8a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15E8A, ft_seed(0x9040001u)); }
    if (all || strstr(env, "sub_15e91")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15E91, ft_seed(0x9041001u)); }
    if (all || strstr(env, "sub_15f17")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15F17, ft_seed(0x9042001u)); }
    if (all || strstr(env, "sub_15f25")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_15F25, ft_seed(0x9043001u)); }
    ...
    if (all || strstr(env, "sub_13733")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_13733, ft_seed(0xB104001u)); }
    if (all || strstr(env, "sub_13743")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_13743, ft_seed(0xB105001u)); }
    if (all || strstr(env, "sub_13753")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_13753, ft_seed(0xB106001u)); }
    if (all || strstr(env, "sub_14199")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_14199, ft_seed(0xB210001u)); }
    if (all || strstr(env, "sub_141a7")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_141A7, ft_seed(0xB211001u)); }
    if (all || strstr(env, "sub_141b3")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_141B3, ft_seed(0xB212001u)); }
    if (all || strstr(env, "sub_141ba")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_141BA, ft_seed(0xB213001u)); }
    if (all || strstr(env, "sub_141e0")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_141E0, ft_seed(0xB214001u)); }
    if (all || strstr(env, "sub_1547e")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_1547E, ft_seed(0xB215001u)); }
    if (all || strstr(env, "sub_15485")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_15485, ft_seed(0xB216001u)); }
    if (all || strstr(env, "sub_1549a")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_1549A, ft_seed(0xB217001u)); }
    if (all || strstr(env, "sub_154a3")) { matched = true; rc |= ft_selftest_b1b(FT_SUB_154A3, ft_seed(0xB218001u)); }
    if (all || strstr(env, "sub_1242e")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1242E, ft_seed(0xB241001u)); }
    if (all || strstr(env, "sub_1246d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1246D, ft_seed(0xB244001u)); }
    if (all || strstr(env, "sub_12634")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_12634, ft_seed(0xB245001u)); }
    if (all || strstr(env, "sub_12669")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_12669, ft_seed(0xB242001u)); }
    if (all || strstr(env, "sub_1267b")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1267B, ft_seed(0xB243001u)); }
    if (all || strstr(env, "sub_1268d")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1268D, ft_seed(0xB246001u)); }
    if (all || strstr(env, "sub_126a9")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_126A9, ft_seed(0xB250001u)); }
    if (all || strstr(env, "sub_1287a")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_1287A, ft_seed(0xB2D2001u)); }
    if (all || strstr(env, "sub_12829")) { matched = true; rc |= ft_selftest_op_unit(FT_SUB_12829, ft_seed(0xB2D3001u)); }
    if (all || strstr(env, "sub_1434c")) { matched = true; rc |= ft_selftest_op13(ft_seed(0xB213401u)); }
    if (all || strstr(env, "sub_1227e")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_1227E, ft_seed(0xB3A1001u)); }
    if (all || strstr(env, "sub_122c0")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_122C0, ft_seed(0xB3A2001u)); }
    if (all || strstr(env, "sub_122f3")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_122F3, ft_seed(0xB3A3001u)); }
    if (all || strstr(env, "sub_12345")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_12345, ft_seed(0xB3A4001u)); }
    if (all || strstr(env, "sub_12312")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_12312, ft_seed(0xB3A5001u)); }
    if (all || strstr(env, "sub_1237f")) { matched = true; rc |= ft_selftest_b3a(FT_SUB_1237F, ft_seed(0xB3A6001u)); }
    if (all || strstr(env, "sub_1250b")) { matched = true; rc |= ft_selftest_b3b(FT_SUB_1250B, ft_seed(0xB3B1001u)); }
    if (all || strstr(env, "sub_12543")) { matched = true; rc |= ft_selftest_b3b(FT_SUB_12543, ft_seed(0xB3B2001u)); }
    if (all || strstr(env, "sub_125a3")) { matched = true; rc |= ft_selftest_b3b(FT_SUB_125A3, ft_seed(0xB3B3001u)); }
    if (all || strstr(env, "sub_125fa")) { matched = true; rc |= ft_selftest_b3b(FT_SUB_125FA, ft_seed(0xB3B4001u)); }
    if (all || strstr(env, "sub_12613")) { matched = true; rc |= ft_selftest_b3b(FT_SUB_12613, ft_seed(0xB3B5001u)); }
    if (all || strstr(env, "sub_120ff")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_120FF, ft_seed(0xB3C1001u)); }
    if (all || strstr(env, "sub_12199")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12199, ft_seed(0xB3C2001u)); }
    if (all || strstr(env, "sub_120d1")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_120D1, ft_seed(0xB3C3001u)); }
    if (all || strstr(env, "sub_12e16")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12E16, ft_seed(0xB3C4001u)); }
    if (all || strstr(env, "sub_12e2d")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12E2D, ft_seed(0xB3C5001u)); }
    if (all || strstr(env, "sub_12e79")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12E79, ft_seed(0xB3C6001u)); }
    if (all || strstr(env, "sub_12e84")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12E84, ft_seed(0xB3C7001u)); }
    if (all || strstr(env, "sub_1201d")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_1201D, ft_seed(0xB3C8001u)); }
    if (all || strstr(env, "sub_12388")) { matched = true; rc |= ft_selftest_12388(ft_seed(0xB3C9001u)); }
    if (all || strstr(env, "sub_117ad")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_117AD, ft_seed(0xB4A1001u)); }
    if (all || strstr(env, "sub_117d0")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_117D0, ft_seed(0xB4A2001u)); }
    if (all || strstr(env, "sub_1183d")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_1183D, ft_seed(0xB4A3001u)); }
    if (all || strstr(env, "sub_118ad")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_118AD, ft_seed(0xB4A4001u)); }
    if (all || strstr(env, "sub_11aa4")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_11AA4, ft_seed(0xB4A5001u)); }
    if (all || strstr(env, "sub_1200a")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_1200A, ft_seed(0xB4A6001u)); }
    if (all || strstr(env, "sub_12034")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_12034, ft_seed(0xB4A7001u)); }
    if (all || strstr(env, "sub_16880")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_16880, ft_seed(0xB4A8001u)); }
    if (all || strstr(env, "sub_11792")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_11792, ft_seed(0xB4A9001u)); }
    if (all || strstr(env, "sub_11f47")) { matched = true; rc |= ft_selftest_hudvga(FT_SUB_11F47, ft_seed(0xB4AA001u)); }
    if (all || strstr(env, "sub_12250")) { matched = true; rc |= ft_selftest_12250(ft_seed(0xB4AD001u)); }
    if (all || strstr(env, "sub_11f93")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_11F93, ft_seed(0xB4AE001u)); }
    if (all || strstr(env, "sub_121f6")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_121F6, ft_seed(0xB4AF001u)); }
    if (all || strstr(env, "sub_121b9")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_121B9, ft_seed(0xB4B0001u)); }
    if (all || strstr(env, "sub_10555")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_10555, ft_seed(0xB4B1001u)); }
    if (all || strstr(env, "sub_1106f")) { matched = true; rc |= ft_selftest_1106f(ft_seed(0xB4B2001u)); }
    if (all || strstr(env, "sub_102ad")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_102AD, ft_seed(0xB4B3001u)); }
    if (all || strstr(env, "sub_1265b")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_1265B, ft_seed(0xB4B4001u)); }
    if (all || strstr(env, "sub_12709")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12709, ft_seed(0xB4B5001u)); }
    if (all || strstr(env, "sub_10e85")) { matched = true; rc |= ft_selftest_10e85(ft_seed(0xB4B6001u)); }
    if (all || strstr(env, "sub_11204")) { matched = true; rc |= ft_selftest_11204(); }
    if (all || strstr(env, "sub_12d72")) { matched = true; rc |= ft_selftest_b3c1(FT_SUB_12D72, ft_seed(0xB4B7001u)); }
    if (all || strstr(env, "sub_1041c")) { matched = true; rc |= ft_selftest_1041c(); }
